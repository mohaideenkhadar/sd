  ...
  "node_modules/prettier/parser-babel.js"(exports, module) {
    !function(t, e) {
      ...
      var t = function(t2, e2) {
        for (var s2 = -1, r2 = e2.length, i2 = t2.length; ++s2 < r2; ) t2[i2 + s2] = e2[s2];
        return t2;
      ...
      }, A = Object.prototype, E = A.hasOwnProperty, C = A.propertyIsEnumerable, x = y(/* @__PURE__ */ function() {
        return arguments;
      }()) ? y : function(t2) {
      ...
      var w = function(...t2) {
        let e2;
        for (const [s2, r2] of t2.entries()) try {
          return { result: r2() };
        } catch (t3) {
          0 === s2 && (e2 = t3);
        }
      ...
      N.default = I;
      const v = (t2) => {
        if ("string" != typeof t2 || 0 === t2.length) return 0;
        if (0 === (t2 = B(t2)).length) return 0;
      ...
      var V = U, H = q;
      function z(t2) {
        if (V === setTimeout) return setTimeout(t2, 0);
        if ((V === U || !V) && setTimeout) return V = setTimeout, setTimeout(t2, 0);
        try {
          return V(t2, 0);
        } catch (e2) {
          try {
      ...
      function $() {
        if (!K) {
          ...
          for (var e2 = G.length; e2; ) {
            for (W = G, G = []; ++X < e2; ) W && W[X].run();
            X = -1, e2 = G.length;
          }
          W = null, K = false, function(t3) {
            if (H === clearTimeout) return clearTimeout(t3);
            if ((H === q || !H) && clearTimeout) return H = clearTimeout, clearTimeout(t3);
            try {
              H(t3);
            } catch (e3) {
              try {
      ...
      var ht = { nextTick: function(t2) {
        ...
        if (arguments.length > 1) for (var s2 = 1; s2 < arguments.length; s2++) e2[s2 - 1] = arguments[s2];
      ...
      class gt {
        constructor(t2, e2) {
          if (e2 = Dt(e2), t2 instanceof gt) {
            if (t2.loose === !!e2.loose && t2.includePrerelease === !!e2.includePrerelease) return t2;
            t2 = t2.version;
          } else if ("string" != typeof t2) throw new TypeError("Invalid Version: ".concat(t2));
          if (t2.length > At) throw new TypeError("version is longer than ".concat(At, " characters"));
          ...
          if (!s2) throw new TypeError("Invalid Version: ".concat(t2));
          if (this.raw = t2, this.major = +s2[1], this.minor = +s2[2], this.patch = +s2[3], this.major > Et || this.major < 0) throw new TypeError("Invalid major version");
          if (this.minor > Et || this.minor < 0) throw new TypeError("Invalid minor version");
          if (this.patch > Et || this.patch < 0) throw new TypeError("Invalid patch version");
          s2[4] ? this.prerelease = s2[4].split(".").map((t3) => {
            if (/^[0-9]+$/.test(t3)) {
              const e3 = +t3;
              if (e3 >= 0 && e3 < Et) return e3;
            }
            return t3;
        ...
        compare(t2) {
          if (ct("SemVer.compare", this.version, this.options, t2), !(t2 instanceof gt)) {
            if ("string" == typeof t2 && t2 === this.version) return 0;
        ...
        comparePre(t2) {
          if (t2 instanceof gt || (t2 = new gt(t2, this.options)), this.prerelease.length && !t2.prerelease.length) return -1;
          if (!this.prerelease.length && t2.prerelease.length) return 1;
          if (!this.prerelease.length && !t2.prerelease.length) return 0;
          let e2 = 0;
          do {
            const s2 = this.prerelease[e2], r2 = t2.prerelease[e2];
            if (ct("prerelease compare", e2, s2, r2), void 0 === s2 && void 0 === r2) return 0;
            if (void 0 === r2) return 1;
            if (void 0 === s2) return -1;
            if (s2 !== r2) return Ft(s2, r2);
          } while (++e2);
        }
        compareBuild(t2) {
          ...
          switch (t2) {
            ...
            case "pre":
              if (0 === this.prerelease.length) this.prerelease = [0];
                ...
                for (; --t3 >= 0; ) "number" == typeof this.prerelease[t3] && (this.prerelease[t3]++, t3 = -2);
      ...
      var wt, Bt, St, Nt, It, vt, kt = (t2, e2, s2) => Pt(t2, e2, s2) >= 0, Lt = "2.3.0", Ot = r(function(t2, e2) {
        ...
        function n2(t3, e3) {
          for (var s3 in e3) a2(e3, s3) && (t3[s3] = e3[s3]);
          return t3;
        }
        var o2 = /^[ \t]*(?:\r\n|\r|\n)/, u2 = /(?:\r\n|\r|\n)[ \t]*$/, h2 = /^(?:[\r\n]|$)/, c2 = /(?:\r\n|\r|\n)([ \t]*)(?:[^ \t\r\n]|$)/, p2 = /^[ \t]*[\r\n][ \t\r\n]*$/;
        ...
        function d2(t3, e3) {
          for (var s3 = "", r3 = 0, i3 = t3.length; r3 < i3; r3++) s3 += t3[r3], r3 < i3 - 1 && (s3 += e3[r3]);
          return s3;
        }
        function D2(t3) {
        ...
        var m2 = function t3(e3) {
          ...
          return n2(function r3(a3) {
            for (var o3 = [], u3 = 1; u3 < arguments.length; u3++) o3[u3 - 1] = arguments[u3];
            if (D2(a3)) {
              var c3 = a3, f2 = (o3[0] === r3 || o3[0] === m2) && p2.test(c3[0]) && h2.test(c3[1]), y2 = f2 ? i3 : s3, A2 = y2.get(c3);
              if (A2 || (A2 = l2(c3, f2, e3), y2.set(c3, A2)), 0 === o3.length) return A2[0];
      ...
      var Gt = { getSupportInfo: function({ plugins: t2 = [], showUnreleased: e2 = false, showDeprecated: s2 = false, showInternal: r2 = false } = {}) {
        const i2 = zt.split("-", 1)[0], a2 = t2.reduce((t3, e3) => [...t3, ...e3.languages || []], []).filter(h2), n2 = (o2 = Object.assign({}, ...t2.map(({ options: t3 }) => t3), Wt), u2 = "name", Object.entries(o2).map(([t3, e3]) => Object.assign({ [u2]: t3 }, e3))).filter((t3) => h2(t3) && c2(t3)).sort((t3, e3) => t3.name === e3.name ? 0 : t3.name < e3.name ? -1 : 1).map(function(t3) {
          ...
          return function(t4, e3) {
            ...
            for (r3 = 0; r3 < a3.length; r3++) s3 = a3[r3], e3.indexOf(s3) >= 0 || (i3[s3] = t4[s3]);
            return i3;
          ...
          e3 = Object.assign({}, e3), Array.isArray(e3.default) && (e3.default = 1 === e3.default.length ? e3.default[0].value : e3.default.filter(h2).sort((t3, e4) => Ht.compare(e4.since, t3.since))[0].value), Array.isArray(e3.choices) && (e3.choices = e3.choices.filter((t3) => h2(t3) && c2(t3)), "parser" === e3.name && function(t3, e4, s4) {
            ...
            for (const i3 of e4) if (i3.parsers) {
              for (const e5 of i3.parsers) if (!r3.has(e5)) {
                r3.add(e5);
        ...
        return (e2, s2, r2) => {
          ...
          for (; n2 >= 0 && n2 < a2; ) {
            ...
            if (t2 instanceof RegExp) {
              if (!t2.test(s3)) return n2;
            } else if (!t2.includes(s3)) return n2;
            i2 ? n2-- : n2++;
          }
      ...
      function te(t2, e2) {
        ...
        if ("/" === t2.charAt(e2) && "*" === t2.charAt(e2 + 1)) {
          for (let s2 = e2 + 2; s2 < t2.length; ++s2) if ("*" === t2.charAt(s2) && "/" === t2.charAt(s2 + 1)) return s2 + 2;
        }
        return e2;
      }
      function ee(t2, e2) {
      ...
      function se(t2, e2, s2) {
        ...
        if (r2) {
          if ("\r" === t2.charAt(e2 - 1) && "\n" === i2) return e2 - 2;
          if ("\n" === i2 || "\r" === i2 || "\u2028" === i2 || "\u2029" === i2) return e2 - 1;
        } else {
          if ("\r" === i2 && "\n" === t2.charAt(e2 + 1)) return e2 + 2;
          if ("\n" === i2 || "\r" === i2 || "\u2028" === i2 || "\u2029" === i2) return e2 + 1;
        }
        return e2;
      }
      ...
      function ie(t2, e2) {
        let s2 = null, r2 = e2;
        for (; r2 !== s2; ) s2 = r2, r2 = Qt(t2, r2), r2 = te(t2, r2), r2 = Yt(t2, r2);
        return r2 = ee(t2, r2), r2 = se(t2, r2), false !== r2 && re(t2, r2);
      }
      function ae(t2, e2) {
        let s2 = null, r2 = e2;
        for (; r2 !== s2; ) s2 = r2, r2 = Yt(t2, r2), r2 = te(t2, r2), r2 = ee(t2, r2), r2 = se(t2, r2);
        return r2;
      }
      ...
      function oe(t2, e2, s2 = 0) {
        let r2 = 0;
        for (let i2 = s2; i2 < t2.length; ++i2) "	" === t2[i2] ? r2 = r2 + e2 - r2 % e2 : r2++;
        return r2;
      }
      function ue(t2, e2) {
      ...
      var pe = { inferParserByLanguage: function(t2, e2) {
        ...
        for (let t3 = 1; t3 < i2; t3++) if (!r2.get(t3)) return t3;
        return i2 + 1;
        ...
        for (let r2 = e2; r2 < s2; ++r2) if ("\n" === t2.charAt(r2)) return true;
        return false;
      ...
      var ye = { locStart: De, locEnd: me, hasSameLocStart: fe, hasSameLoc: function(t2, e2) {
        ...
        !function() {
          ...
          t2.exports = { isExpression: function(t3) {
            ...
            var e3;
            if ("IfStatement" !== t3.type) return false;
            if (null == t3.alternate) return false;
            e3 = t3.consequent;
            do {
              if ("IfStatement" === e3.type && null == e3.alternate) return true;
              e3 = s2(e3);
            } while (e3);
            return false;
        ...
        !function() {
          ...
          function n2(t3) {
            ...
            if (i3 = t3.charCodeAt(0), !e2.isIdentifierStartES5(i3)) return false;
            for (s3 = 1, r3 = t3.length; s3 < r3; ++s3) if (i3 = t3.charCodeAt(s3), !e2.isIdentifierPartES5(i3)) return false;
            return true;
          }
          function o2(t3) {
            var s3, r3, i3, a3, n3;
            ...
            for (n3 = e2.isIdentifierStartES6, s3 = 0, r3 = t3.length; s3 < r3; ++s3) {
              if (55296 <= (i3 = t3.charCodeAt(s3)) && i3 <= 56319) {
                ...
                if (!(56320 <= (a3 = t3.charCodeAt(s3)) && a3 <= 57343)) return false;
      ...
      const rs = {};
      for (const [t2, e2] of [["|>"], ["??"], ["||"], ["&&"], ["|"], ["^"], ["&"], ["==", "===", "!=", "!=="], ["<", ">", "<=", ">=", "in", "instanceof"], [">>", "<<", ">>>"], ["+", "-"], ["*", "/", "%"], ["**"]].entries()) for (const s2 of e2) rs[s2] = t2;
      function is(t2) {
        return rs[t2];
      }
      const as = /* @__PURE__ */ new WeakMap();
      function ns(t2) {
        if (as.has(t2)) return as.get(t2);
        const e2 = [];
      ...
      const cs = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 }, ps = (t2, e2) => {
        if ("function" == typeof t2 && (e2 = t2, t2 = 0), t2 || e2) return (s2, r2, i2) => !(t2 & cs.Leading && !s2.leading || t2 & cs.Trailing && !s2.trailing || t2 & cs.Dangling && (s2.leading || s2.trailing) || t2 & cs.Block && !Le(s2) || t2 & cs.Line && !Oe(s2) || t2 & cs.First && 0 !== r2 || t2 & cs.Last && r2 !== i2.length - 1 || t2 & cs.PrettierIgnore && !us(s2) || e2 && !e2(s2));
      };
      function ls(t2, e2, s2) {
        if (!t2 || !Pe(t2.comments)) return false;
        const r2 = ps(e2, s2);
        return !r2 || t2.comments.some(r2);
      }
      function ds(t2, e2, s2) {
        if (!t2 || !Array.isArray(t2.comments)) return [];
        const r2 = ps(e2, s2);
      ...
      var ms = { getFunctionParameters: ns, iterateFunctionParametersPath: function(t2, e2) {
        ...
        if (t2.rest) return true;
        const e2 = ns(t2);
        return e2.length > 0 && "RestElement" === Fe(e2).type;
      }, getLeftSidePathName: function(t2, e2) {
        if (e2.expressions) return ["expressions", 0];
        if (e2.left) return ["left"];
        if (e2.test) return ["test"];
        if (e2.object) return ["object"];
        if (e2.callee) return ["callee"];
        if (e2.tag) return ["tag"];
        if (e2.argument) return ["argument"];
        if (e2.expression) return ["expression"];
        ...
        if (Array.isArray(e2)) return e2.some((e3) => t2(e3, s2));
        const r2 = s2(e2);
        ...
        let e2 = 0;
        for (const s2 of t2) if (Ue(s2)) {
          if (e2 += 1, e2 > 1) return true;
        } else if (Xe(s2)) {
          for (const t3 of s2.arguments) if (Ue(t3)) return true;
        }
        return false;
        ...
        return 0 !== s2.length && s2.every((t3) => {
          if (ls(t3)) return false;
          if ("Identifier" === t3.type || "ThisExpression" === t3.type) return true;
          if (Je(t3)) {
            let e3 = t3;
            for (; Je(e3); ) {
              if ("Identifier" !== e3.property.type && "Literal" !== e3.property.type && "StringLiteral" !== e3.property.type && "NumericLiteral" !== e3.property.type) return false;
              if (e3 = e3.object, ls(e3)) return false;
            }
        ...
        }(e2.arguments[0]) || _e(e2.arguments[0]))) return !(e2.arguments[2] && !je(e2.arguments[2])) && ((2 === e2.arguments.length ? Ue(e2.arguments[1]) : function(t3) {
        ...
        if ("markdown" !== t2.parentParser && "mdx" !== t2.parentParser) return false;
        const s2 = e2.getNode();
        if (!s2.expression || !Ve(s2.expression)) return false;
        ...
        if (!ls(t2)) return false;
        const e2 = Fe(ds(t2, cs.Dangling));
        return e2 && !Le(e2);
      }, rawText: Ze, returnArgumentHasLeadingComment: function(t2, e2) {
        if ($e(t2.originalText, e2)) return true;
        if (ke(e2)) {
          let r2, i2 = e2;
          for (; r2 = (s2 = i2).expressions ? s2.expressions[0] : s2.left || s2.test || s2.callee || s2.object || s2.tag || s2.argument || s2.expression; ) if (i2 = r2, $e(t2.originalText, i2)) return true;
        }
        var s2;
        return false;
      ...
      function Vs({ comment: t2, precedingNode: e2, enclosingNode: s2, followingNode: r2, text: i2 }) {
        if (!s2 || "IfStatement" !== s2.type || !r2) return false;
      ...
      function Hs({ comment: t2, precedingNode: e2, enclosingNode: s2, followingNode: r2, text: i2 }) {
        if (!s2 || "WhileStatement" !== s2.type || !r2) return false;
      ...
      function Xs({ comment: t2, precedingNode: e2, enclosingNode: s2, followingNode: r2 }) {
        if (s2 && ("ClassDeclaration" === s2.type || "ClassExpression" === s2.type || "DeclareClass" === s2.type || "DeclareInterface" === s2.type || "InterfaceDeclaration" === s2.type || "TSInterfaceDeclaration" === s2.type)) {
          if (Ps(s2.decorators) && (!r2 || "Decorator" !== r2.type)) return Fs(fs(s2.decorators), t2), true;
          if (s2.body && r2 === s2.body) return _s(s2.body, t2), true;
          if (r2) {
            for (const i2 of ["implements", "extends", "mixins"]) if (s2[i2] && r2 === s2[i2][0]) return !e2 || e2 !== s2.id && e2 !== s2.typeParameters && e2 !== s2.superClass ? gs(s2, t2, i2) : Fs(e2, t2), true;
          }
        }
        return false;
      }
      ...
      function Ys({ comment: t2, enclosingNode: e2, text: s2 }) {
        if (!e2 || "ArrowFunctionExpression" !== e2.type) return false;
      ...
      function Zs({ comment: t2, precedingNode: e2, enclosingNode: s2, followingNode: r2, text: i2 }) {
        if (e2 && "FunctionTypeParam" === e2.type && s2 && "FunctionTypeAnnotation" === s2.type && r2 && "FunctionTypeParam" !== r2.type) return Fs(e2, t2), true;
        if (e2 && ("Identifier" === e2.type || "AssignmentPattern" === e2.type) && s2 && mr(s2) && ")" === Es(i2, t2, js)) return Fs(e2, t2), true;
        if (s2 && "FunctionDeclaration" === s2.type && r2 && "BlockStatement" === r2.type) {
          const e3 = (() => {
            const t3 = ws(s2);
            if (t3.length > 0) return As(i2, js(fs(t3)));
            const e4 = As(i2, js(s2.id));
            return false !== e4 && As(i2, e4 + 1);
          })();
          if (Rs(t2) > e3) return _s(r2, t2), true;
        }
        return false;
      }
      ...
      function dr({ comment: t2, enclosingNode: e2, followingNode: s2 }) {
        if (Bs(t2) && e2 && "TSMappedType" === e2.type && s2 && "TSTypeParameter" === s2.type && s2.constraint) return e2.prettierIgnore = true, t2.unignore = true, true;
      }
      ...
      var yr = { handleOwnLineComment: function(t2) {
        ...
        if (("typescript" === e2.parser || "flow" === e2.parser || "espree" === e2.parser || "meriyah" === e2.parser) && "MethodDefinition" === t2.type && t2.value && "FunctionExpression" === t2.value.type && 0 === ws(t2.value).length && !t2.value.returnType && !Ps(t2.value.typeParameters) && t2.value.body) return [...t2.decorators || [], t2.key, t2.value.body];
        ...
        if ("typescript" !== e2.parser && "flow" !== e2.parser && "espree" !== e2.parser && "meriyah" !== e2.parser) {
          ...
          t2 = br(t2, (t3) => {
            ...
            if ("ParenthesizedExpression" === t3.type) {
              ...
              if ("TypeCastExpression" === s2.type) return s2.range = t3.range, s2;
              const r2 = Cr(t3);
              if (!e3.has(r2)) return s2.extra = Object.assign({}, s2.extra, { parenthesized: true }), s2;
            }
          });
        }
        return t2 = br(t2, (t3) => {
          switch (t3.type) {
            ...
            case "LogicalExpression":
              if (Pr(t3)) return Tr(t3);
              break;
            case "VariableDeclaration": {
              const s2 = Ar(t3.declarations);
              s2 && s2.init && function(t4, s3) {
                if (";" === e2.originalText[xr(s3)]) return;
      ...
      function Sr() {
        if (void 0 === wr) {
          ...
          if (e2[0] = 1, e2[1] = 2, 258 === s2[0]) wr = "BE";
          else {
            if (513 !== s2[0]) throw new Error("unable to figure out endianess");
            wr = "LE";
          }
        }
        return wr;
      ...
      function pi(t2) {
        ...
        let s2 = "";
        for (; s2 !== t2; ) s2 = t2, t2 = t2.replace(oi, "".concat(e2, "$1 $2").concat(e2));
      ...
      var Di = { guessEndOfLine: function(t2) {
        ...
        if ("\n" === e2) s2 = /\n/g;
          ...
          if ("\r\n" !== e2) throw new Error('Unexpected "eol" '.concat(JSON.stringify(e2), "."));
          s2 = /\r\n/g;
        }
      ...
      Mi.parenR.updateContext = Mi.braceR.updateContext = function() {
        if (1 === this.state.context.length) return void (this.state.exprAllowed = true);
      ...
      function ra(t2, e2) {
        ...
        for (let r2 = 0, i2 = e2.length; r2 < i2; r2 += 2) {
          if (s2 += e2[r2], s2 > t2) return false;
          if (s2 += e2[r2 + 1], s2 >= t2) return true;
        }
        return false;
      }
      function ia(t2) {
      ...
      class Fa {
        ...
        declareName(t2, e2, s2) {
          ...
          if (8 & e2 || 16 & e2) this.checkRedeclarationInScope(r2, t2, e2, s2), 16 & e2 ? r2.functions.push(t2) : r2.lexical.push(t2), 8 & e2 && this.maybeExportDefined(r2, t2);
          else if (4 & e2) for (let i2 = this.scopeStack.length - 1; i2 >= 0 && (r2 = this.scopeStack[i2], this.checkRedeclarationInScope(r2, t2, e2, s2), r2.var.push(t2), this.maybeExportDefined(r2, t2), !(259 & r2.flags)); --i2) ;
        ...
        currentVarScope() {
          for (let t2 = this.scopeStack.length - 1; ; t2--) {
            ...
            if (259 & e2.flags) return e2;
          }
        }
        currentThisScope() {
          for (let t2 = this.scopeStack.length - 1; ; t2--) {
            const e2 = this.scopeStack[t2];
            if ((259 & e2.flags || 64 & e2.flags) && !(4 & e2.flags)) return e2;
          }
        }
      }
      class ga extends xa {
      ...
      class ba extends Fa {
        ...
        declareName(t2, e2, s2) {
          ...
          if (e2 & Ca) return this.checkRedeclarationInScope(r2, t2, e2, s2), this.maybeExportDefined(r2, t2), void r2.declareFunctions.push(t2);
      ...
      function Ma(t2) {
        if ("JSXIdentifier" === t2.type) return t2.name;
        if ("JSXNamespacedName" === t2.type) return t2.namespace.name + ":" + t2.name.name;
        if ("JSXMemberExpression" === t2.type) return Ma(t2.object) + "." + Ma(t2.property);
      ...
      class ja extends Fa {
        ...
        declareName(t2, e2, s2) {
          const r2 = this.currentScope();
          if (e2 & Ea) return this.maybeExportDefined(r2, t2), void r2.exportOnlyBindings.push(t2);
      ...
      function qa(t2) {
        if (null == t2) throw new Error("Unexpected ".concat(t2, " value."));
        return t2;
      }
      function Va(t2) {
      ...
      const $a = { estree: (t2) => class extends t2 {
        ...
        parseSubscript(t3, e2, s2, r2, i2) {
          ...
          } else "MemberExpression" !== a2.type && "CallExpression" !== a2.type || (a2.optional = false);
          return a2;
        }
        ...
        jsxReadToken() {
          ...
          for (; ; ) {
            if (this.state.pos >= this.length) throw this.raise(this.state.start, La.UnterminatedJsxContent);
        ...
        jsxReadString(t3) {
          ...
          for (; ; ) {
            if (this.state.pos >= this.length) throw this.raise(this.state.start, Gi.UnterminatedString);
        ...
        jsxParseNamespacedName() {
          ...
          if (!this.eat(Mi.colon)) return s2;
        ...
        jsxParseElementName() {
          ...
          if ("JSXNamespacedName" === s2.type) return s2;
          for (; this.eat(Mi.dot); ) {
            const r2 = this.startNodeAt(t3, e2);
        ...
        jsxParseExpressionContainer(t3) {
          if (this.match(Mi.braceR)) t3.expression = this.jsxParseEmptyExpression();
          else {
        ...
        jsxParseOpeningElementAfterName(t3) {
          const e2 = [];
          for (; !this.match(Mi.slash) && !this.match(Mi.jsxTagEnd); ) e2.push(this.jsxParseAttribute());
        ...
        jsxParseElementAt(t3, e2) {
          ...
          if (Oa(i2) ? (s2.openingFragment = i2, s2.closingFragment = a2) : (s2.openingElement = i2, s2.closingElement = a2), s2.children = r2, this.isRelational("<")) throw this.raise(this.state.start, La.UnwrappedAdjacentJSXElements);
        ...
        getTokenFromCode(t3) {
          if (this.state.inPropertyName) return super.getTokenFromCode(t3);
          const e2 = this.curContext();
          if (e2 === $i.j_expr) return this.jsxReadToken();
          if (e2 === $i.j_oTag || e2 === $i.j_cTag) {
            if (ia(t3)) return this.jsxReadWord();
            if (62 === t3) return ++this.state.pos, this.finishToken(Mi.jsxTagEnd);
            if ((34 === t3 || 39 === t3) && e2 === $i.j_oTag) return this.jsxReadString(t3);
          }
        ...
        updateContext(t3) {
          if (this.match(Mi.braceL)) {
            ...
            if (!this.match(Mi.slash) || t3 !== Mi.jsxTagStart) return super.updateContext(t3);
        ...
        addComment(t3) {
          if (void 0 === this.flowPragma) {
            ...
            if (e2) if ("flow" === e2[1]) this.flowPragma = "flow";
            else {
              if ("noflow" !== e2[1]) throw new Error("Unexpected flow pragma");
        ...
        flowParseDeclare(t3, e2) {
          if (this.match(Mi._class)) return this.flowParseDeclareClass(t3);
          if (this.match(Mi._function)) return this.flowParseDeclareFunction(t3);
          if (this.match(Mi._var)) return this.flowParseDeclareVariable(t3);
          if (this.eatContextual("module")) return this.match(Mi.dot) ? this.flowParseDeclareModuleExports(t3) : (e2 && this.raise(this.state.lastTokStart, Ta.NestedDeclareModule), this.flowParseDeclareModule(t3));
          if (this.isContextual("type")) return this.flowParseDeclareTypeAlias(t3);
          if (this.isContextual("opaque")) return this.flowParseDeclareOpaqueType(t3);
          if (this.isContextual("interface")) return this.flowParseDeclareInterface(t3);
          if (this.match(Mi._export)) return this.flowParseDeclareExportDeclaration(t3, e2);
          throw this.unexpected();
        }
        ...
        flowParseDeclareExportDeclaration(t3, e2) {
          if (this.expect(Mi._export), this.eat(Mi._default)) return this.match(Mi._function) || this.match(Mi._class) ? t3.declaration = this.flowParseDeclare(this.startNode()) : (t3.declaration = this.flowParseType(), this.semicolon()), t3.default = true, this.finishNode(t3, "DeclareExportDeclaration");
          ...
          if (this.match(Mi._var) || this.match(Mi._function) || this.match(Mi._class) || this.isContextual("opaque")) return t3.declaration = this.flowParseDeclare(this.startNode()), t3.default = false, this.finishNode(t3, "DeclareExportDeclaration");
          if (this.match(Mi.star) || this.match(Mi.braceL) || this.isContextual("interface") || this.isContextual("type") || this.isContextual("opaque")) return "ExportNamedDeclaration" === (t3 = this.parseExport(t3)).type && (t3.type = "ExportDeclaration", t3.default = false, delete t3.exportKind), t3.type = "Declare" + t3.type, t3;
          throw this.unexpected();
        }
        ...
        flowParseInterfaceish(t3, e2 = false) {
          if (t3.id = this.flowParseRestrictedIdentifier(!e2, true), this.scope.declareName(t3.id.name, e2 ? 17 : 9, t3.id.start), this.isRelational("<") ? t3.typeParameters = this.flowParseTypeParameterDeclaration() : t3.typeParameters = null, t3.extends = [], t3.implements = [], t3.mixins = [], this.eat(Mi._extends)) do {
        ...
        flowParseTypeParameterInstantiation() {
          ...
          for (this.state.noAnonFunctionType = false; !this.isRelational(">"); ) t3.params.push(this.flowParseType()), this.isRelational(">") || this.expect(Mi.comma);
        ...
        flowParseTypeParameterInstantiationCallOrNew() {
          const t3 = this.startNode(), e2 = this.state.inType;
          for (t3.params = [], this.state.inType = true, this.expectRelational("<"); !this.isRelational(">"); ) t3.params.push(this.flowParseTypeOrImplicitInstantiation()), this.isRelational(">") || this.expect(Mi.comma);
          return this.expectRelational(">"), this.state.inType = e2, this.finishNode(t3, "TypeParameterInstantiation");
        }
        flowParseInterfaceType() {
          const t3 = this.startNode();
          if (this.expectContextual("interface"), t3.extends = [], this.eat(Mi._extends)) do {
            t3.extends.push(this.flowParseInterfaceExtends());
          } while (this.eat(Mi.comma));
        ...
        flowParseObjectTypeMethodish(t3) {
          for (t3.params = [], t3.rest = null, t3.typeParameters = null, t3.this = null, this.isRelational("<") && (t3.typeParameters = this.flowParseTypeParameterDeclaration()), this.expect(Mi.parenL), this.match(Mi._this) && (t3.this = this.flowParseFunctionTypeParam(true), t3.this.name = null, this.match(Mi.parenR) || this.expect(Mi.comma)); !this.match(Mi.parenR) && !this.match(Mi.ellipsis); ) t3.params.push(this.flowParseFunctionTypeParam(false)), this.match(Mi.parenR) || this.expect(Mi.comma);
        ...
        flowParseObjectType({ allowStatic: t3, allowExact: e2, allowSpread: s2, allowProto: r2, allowInexact: i2 }) {
          ...
          for (e2 && this.match(Mi.braceBarL) ? (this.expect(Mi.braceBarL), o2 = Mi.braceBarR, u2 = true) : (this.expect(Mi.braceL), o2 = Mi.braceR, u2 = false), n2.exact = u2; !this.match(o2); ) {
            ...
            if (this.eat(Mi.bracketL)) null != a3 && this.unexpected(a3), this.eat(Mi.bracketL) ? (p2 && this.unexpected(p2.start), n2.internalSlots.push(this.flowParseObjectTypeInternalSlot(c3, e3))) : n2.indexers.push(this.flowParseObjectTypeIndexer(c3, e3, p2));
            else if (this.match(Mi.parenL) || this.isRelational("<")) null != a3 && this.unexpected(a3), p2 && this.unexpected(p2.start), n2.callProperties.push(this.flowParseObjectTypeCallProperty(c3, e3));
            else {
              let t4 = "init";
        ...
        flowParseTupleType() {
          const t3 = this.startNode();
          for (t3.types = [], this.expect(Mi.bracketL); this.state.pos < this.length && !this.match(Mi.bracketR) && (t3.types.push(this.flowParseType()), !this.match(Mi.bracketR)); ) this.expect(Mi.comma);
        ...
        flowParseFunctionTypeParams(t3 = []) {
          let e2 = null, s2 = null;
          for (this.match(Mi._this) && (s2 = this.flowParseFunctionTypeParam(true), s2.name = null, this.match(Mi.parenR) || this.expect(Mi.comma)); !this.match(Mi.parenR) && !this.match(Mi.ellipsis); ) t3.push(this.flowParseFunctionTypeParam(false)), this.match(Mi.parenR) || this.expect(Mi.comma);
        ...
        flowParsePrimaryType() {
          ...
          switch (this.state.type) {
            ...
            case Mi.relational:
              if ("<" === this.state.value) return s2.typeParameters = this.flowParseTypeParameterDeclaration(), this.expect(Mi.parenL), r2 = this.flowParseFunctionTypeParams(), s2.params = r2.params, s2.rest = r2.rest, s2.this = r2._this, this.expect(Mi.parenR), this.expect(Mi.arrow), s2.returnType = this.flowParseType(), this.finishNode(s2, "FunctionTypeAnnotation");
              break;
            case Mi.parenL:
              if (this.next(), !this.match(Mi.parenR) && !this.match(Mi.ellipsis)) if (this.match(Mi.name) || this.match(Mi._this)) {
                const t4 = this.lookahead().type;
                a2 = t4 !== Mi.question && t4 !== Mi.colon;
              } else a2 = true;
              if (a2) {
                if (this.state.noAnonFunctionType = false, i2 = this.flowParseType(), this.state.noAnonFunctionType = n2, this.state.noAnonFunctionType || !(this.match(Mi.comma) || this.match(Mi.parenR) && this.lookahead().type === Mi.arrow)) return this.expect(Mi.parenR), i2;
                this.eat(Mi.comma);
              }
            ...
            case Mi.plusMin:
              if ("-" === this.state.value) {
                if (this.next(), this.match(Mi.num)) return this.parseLiteral(-this.state.value, "NumberLiteralTypeAnnotation", s2.start, s2.loc.start);
                if (this.match(Mi.bigint)) return this.parseLiteral(-this.state.value, "BigIntLiteralTypeAnnotation", s2.start, s2.loc.start);
        ...
        flowParseIntersectionType() {
          ...
          for (t3.types = [e2]; this.eat(Mi.bitwiseAND); ) t3.types.push(this.flowParseAnonFunctionWithoutParens());
        ...
        flowParseUnionType() {
          ...
          for (t3.types = [e2]; this.eat(Mi.bitwiseOR); ) t3.types.push(this.flowParseIntersectionType());
        ...
        parseExpressionStatement(t3, e2) {
          if ("Identifier" === e2.type) {
            if ("declare" === e2.name) {
              if (this.match(Mi._class) || this.match(Mi.name) || this.match(Mi._function) || this.match(Mi._var) || this.match(Mi._export)) return this.flowParseDeclare(t3);
            } else if (this.match(Mi.name)) {
              if ("interface" === e2.name) return this.flowParseInterface(t3);
              if ("type" === e2.name) return this.flowParseTypeAlias(t3);
              if ("opaque" === e2.name) return this.flowParseOpaqueType(t3, false);
            }
          }
        ...
        parseConditional(t3, e2, s2, r2) {
          if (!this.match(Mi.question)) return t3;
          if (r2) {
          ...
          if (u2 || c2.length > 0) {
            ...
            if (c2.length > 0) {
              ...
              for (let e3 = 0; e3 < c2.length; e3++) t4.push(c2[e3].start);
        ...
        getArrowLikeExpressions(t3, e2) {
          ...
          return e2 ? (r2.forEach((t4) => this.finishArrowValidation(t4)), [r2, []]) : function(t4, e3) {
            const s3 = [], r3 = [];
            for (let i2 = 0; i2 < t4.length; i2++) (e3(t4[i2], i2, t4) ? s3 : r3).push(t4[i2]);
            return [s3, r3];
        ...
        parseClassMember(t3, e2, s2) {
          ...
          if (this.isContextual("declare")) {
            if (this.parseClassMemberFromModifier(t3, e2)) return;
            e2.declare = true;
          }
        ...
        getTokenFromCode(t3) {
          ...
          return 123 === t3 && 124 === e2 ? this.finishOp(Mi.braceBarL, 2) : !this.state.inType || 62 !== t3 && 60 !== t3 ? this.state.inType && 63 === t3 ? 46 === e2 ? this.finishOp(Mi.questionDot, 2) : this.finishOp(Mi.question, 1) : /* @__PURE__ */ function(t4, e3) {
            return 64 === t4 && 64 === e3;
        ...
        checkLVal(t3, ...e2) {
          if ("TypeCastExpression" !== t3.type) return super.checkLVal(t3, ...e2);
        }
        parseClassProperty(t3) {
        ...
        parseImportSpecifier(t3) {
          ...
          } else if (null !== i2 && (this.match(Mi.name) || this.state.type.keyword)) e2.imported = this.parseIdentifier(true), e2.importKind = i2, this.eatContextual("as") ? e2.local = this.parseIdentifier() : (a2 = true, e2.local = e2.imported.__clone());
          else {
            if ("StringLiteral" === r2.type) throw this.raise(e2.start, Gi.ImportBindingIsString, r2.value);
        ...
        parseMaybeAssign(t3, e2, s2) {
          ...
          if (this.hasPlugin("jsx") && (this.match(Mi.jsxTagStart) || this.isRelational("<"))) {
            if (a2 = this.state.clone(), i2 = this.tryParse(() => super.parseMaybeAssign(t3, e2, s2), a2), !i2.error) return i2.node;
          ...
          if (null != (r2 = i2) && r2.error || this.isRelational("<")) {
            ...
            if (u2.node && "ArrowFunctionExpression" === this.maybeUnwrapTypeCastExpression(u2.node).type) {
              if (!u2.error && !u2.aborted) return u2.node.async && this.raise(r3.start, Ta.UnexpectedTypeParameterBeforeAsyncArrowFunction), u2.node;
              h2 = u2.node;
            }
            if (null != (n2 = i2) && n2.node) return this.state = i2.failState, i2.node;
            if (h2) return this.state = u2.failState, h2;
            if (null != (o2 = i2) && o2.thrown) throw i2.error;
            if (u2.thrown) throw u2.error;
        ...
        checkParams(t3, e2, s2) {
          if (!s2 || -1 === this.state.noArrowParamsConversionAt.indexOf(t3.start)) {
            for (let e3 = 0; e3 < t3.params.length; e3++) this.isThisParam(t3.params[e3]) && e3 > 0 && this.raise(t3.params[e3].start, Ta.ThisParamMustBeFirst);
        ...
        parseSubscripts(t3, e2, s2, r2) {
          if ("Identifier" === t3.type && "async" === t3.name && -1 !== this.state.noArrowAt.indexOf(e2)) {
            ...
            if (!a2.error && !a2.aborted) return a2.node;
            const n2 = this.tryParse(() => super.parseSubscripts(t3, e2, s2, r2), i2);
            if (n2.node && !n2.error) return n2.node;
            if (a2.node) return this.state = a2.failState, a2.node;
            if (n2.node) return this.state = n2.failState, n2.node;
        ...
        parseSubscript(t3, e2, s2, r2, i2) {
          if (this.match(Mi.questionDot) && this.isLookaheadToken_lt()) {
            if (i2.optionalChainMember = true, r2) return i2.stop = true, t3;
            this.next();
          ...
          if (!r2 && this.shouldParseTypes() && this.isRelational("<")) {
            ...
            if (a2.node) return a2.error && (this.state = a2.failState), a2.node;
          }
        ...
        parseAsyncArrowWithTypeParameters(t3, e2) {
          const s2 = this.startNodeAt(t3, e2);
          if (this.parseFunctionParams(s2), this.parseArrow(s2)) return this.parseArrowExpression(s2, void 0, true);
        }
        readToken_mult_modulo(t3) {
          const e2 = this.input.charCodeAt(this.state.pos + 1);
          if (42 === t3 && 47 === e2 && this.state.hasFlowComment) return this.state.hasFlowComment = false, this.state.pos += 2, void this.nextToken();
        ...
        skipBlockComment() {
          if (this.hasPlugin("flowComments") && this.skipFlowComment()) return this.state.hasFlowComment && this.unexpected(null, Ta.NestedFlowComment), this.hasFlowCommentCompletion(), this.state.pos += this.skipFlowComment(), void (this.state.hasFlowComment = true);
          if (this.state.hasFlowComment) {
            const t3 = this.input.indexOf("*-/", this.state.pos += 2);
            if (-1 === t3) throw this.raise(this.state.pos - 2, Gi.UnterminatedComment);
            this.state.pos = t3 + 3;
        ...
        skipFlowComment() {
          ...
          let e2 = 2;
          for (; [32, 9].includes(this.input.charCodeAt(t3 + e2)); ) e2++;
        ...
        hasFlowCommentCompletion() {
          if (-1 === this.input.indexOf("*/", this.state.pos)) throw this.raise(this.state.pos, Gi.UnterminatedComment);
        }
        ...
        flowEnumStringMembers(t3, e2, { enumName: s2 }) {
          if (0 === t3.length) return e2;
          if (0 === e2.length) return t3;
          if (e2.length > t3.length) {
            for (const e3 of t3) this.flowEnumErrorStringMemberInconsistentlyInitailized(e3.start, { enumName: s2 });
            return e2;
          }
          for (const t4 of e2) this.flowEnumErrorStringMemberInconsistentlyInitailized(t4.start, { enumName: s2 });
          return t3;
        }
        flowEnumParseExplicitType({ enumName: t3 }) {
          if (this.eatContextual("of")) {
            if (!this.match(Mi.name)) throw this.flowEnumErrorInvalidExplicitType(this.state.start, { enumName: t3, suppliedType: null });
          ...
          switch (t3.hasUnknownMembers = a2, r2) {
            ...
            default: {
              ...
              if (a3 || n2 || o2 || u2) {
                if (a3 || n2) {
                  if (!n2 && !o2 && a3 >= u2) {
                    for (const t4 of i2.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(t4.start, { enumName: e2, memberName: t4.id.name });
                    return t3.members = i2.booleanMembers, this.expect(Mi.braceR), this.finishNode(t3, "EnumBooleanBody");
                  }
                  if (!a3 && !o2 && n2 >= u2) {
                    for (const t4 of i2.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(t4.start, { enumName: e2, memberName: t4.id.name });
        ...
        tsParseList(t3, e2) {
          const s2 = [];
          for (; !this.tsIsListTerminator(t3); ) s2.push(e2());
          return s2;
        }
        ...
        tsTryParseIndexSignature(t3) {
          if (!this.match(Mi.bracketL) || !this.tsLookAhead(this.tsIsUnambiguouslyIndexSignature.bind(this))) return;
        ...
        tsParsePropertyOrMethodSignature(t3, e2) {
          ...
          if (this.match(Mi.parenL) || this.isRelational("<")) {
            ...
            const r2 = s2;
            if (r2.kind && this.isRelational("<") && this.raise(this.state.pos, Ha.AccesorCannotHaveTypeParameters), this.tsFillSignature(Mi.colon, r2), this.tsParseTypeMemberSemicolon(), "get" === r2.kind) r2.parameters.length > 0 && (this.raise(this.state.pos, Gi.BadGetterArity), this.isThisParam(r2.parameters[0]) && this.raise(this.state.pos, Ha.AccesorCannotDeclareThisParameter));
            else if ("set" === r2.kind) {
              if (1 !== r2.parameters.length) this.raise(this.state.pos, Gi.BadSetterArity);
              else {
        ...
        tsParseTypeMember() {
          const t3 = this.startNode();
          if (this.match(Mi.parenL) || this.isRelational("<")) return this.tsParseSignatureMember("TSCallSignatureDeclaration", t3);
          ...
          switch (this.state.type) {
            ...
            case Mi.plusMin:
              if ("-" === this.state.value) {
                ...
                if (e2.type !== Mi.num && e2.type !== Mi.bigint) throw this.unexpected();
        ...
        tsParseArrayTypeOrHigher() {
          ...
          for (; !this.hasPrecedingLineBreak() && this.eat(Mi.bracketL); ) if (this.match(Mi.bracketR)) {
            const e2 = this.startNodeAtNode(t3);
        ...
        tsSkipParameterStart() {
          if (this.match(Mi.name) || this.match(Mi._this)) return this.next(), true;
          if (this.match(Mi.braceL)) {
            let t3 = 1;
            for (this.next(); t3 > 0; ) this.match(Mi.braceL) ? ++t3 : this.match(Mi.braceR) && --t3, this.next();
            return true;
          }
          if (this.match(Mi.bracketL)) {
            let t3 = 1;
            for (this.next(); t3 > 0; ) this.match(Mi.bracketL) ? ++t3 : this.match(Mi.bracketR) && --t3, this.next();
            return true;
          }
          return false;
        }
        tsIsUnambiguouslyStartOfFunctionType() {
          if (this.next(), this.match(Mi.parenR) || this.match(Mi.ellipsis)) return true;
          if (this.tsSkipParameterStart()) {
            if (this.match(Mi.colon) || this.match(Mi.comma) || this.match(Mi.question) || this.match(Mi.eq)) return true;
            if (this.match(Mi.parenR) && (this.next(), this.match(Mi.arrow))) return true;
          }
          return false;
        }
        tsParseTypeOrTypePredicateAnnotation(t3) {
          return this.tsInType(() => {
            ...
            if (!i2) return r2 ? (s2.parameterName = this.parseIdentifier(), s2.asserts = r2, e2.typeAnnotation = this.finishNode(s2, "TSTypePredicate"), this.finishNode(e2, "TSTypeAnnotation")) : this.tsParseTypeAnnotation(false, e2);
        ...
        tsParseTypePredicateAsserts() {
          if (!this.match(Mi.name) || "asserts" !== this.state.value || this.hasPrecedingLineBreak()) return false;
        ...
        tsParseType() {
          ...
          if (this.hasPrecedingLineBreak() || !this.eat(Mi._extends)) return t3;
          const e2 = this.startNodeAtNode(t3);
        ...
        tsParseModuleOrNamespaceDeclaration(t3, e2 = false) {
          ...
          } else this.scope.enter(ya), this.prodParam.enter(0), t3.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
        ...
        tsParseExternalModuleReference() {
          const t3 = this.startNode();
          if (this.expectContextual("require"), this.expect(Mi.parenL), !this.match(Mi.string)) throw this.unexpected();
        ...
        tsTryParseAndCatch(t3) {
          ...
          if (!e2.aborted && e2.node) return e2.error && (this.state = e2.failState), e2.node;
        }
        tsTryParse(t3) {
          const e2 = this.state.clone(), s2 = t3();
        ...
        tsTryParseDeclare(t3) {
          ...
          return this.isContextual("let") && (s2 = Mi._var, e2 = "let"), this.tsInAmbientContext(() => {
            switch (s2) {
              ...
              case Mi._const:
                if (this.match(Mi._const) && this.isLookaheadContextual("enum")) return this.expect(Mi._const), this.expectContextual("enum"), this.tsParseEnumDeclaration(t3, true);
              case Mi._var:
        ...
        tsParseExpressionStatement(t3, e2) {
          switch (e2.name) {
            case "declare": {
              ...
              if (e3) return e3.declare = true, e3;
              break;
            }
            case "global":
              if (this.match(Mi.braceL)) {
        ...
        tsParseDeclaration(t3, e2, s2) {
          switch (e2) {
            case "abstract":
              if (this.tsCheckLineTerminator(s2) && (this.match(Mi._class) || this.match(Mi.name))) return this.tsParseAbstractDeclaration(t3);
              break;
            case "enum":
              if (s2 || this.match(Mi.name)) return s2 && this.next(), this.tsParseEnumDeclaration(t3, false);
              break;
            case "interface":
              if (this.tsCheckLineTerminator(s2) && this.match(Mi.name)) return this.tsParseInterfaceDeclaration(t3);
              break;
            case "module":
              if (this.tsCheckLineTerminator(s2)) {
                if (this.match(Mi.string)) return this.tsParseAmbientExternalModuleDeclaration(t3);
                if (this.match(Mi.name)) return this.tsParseModuleOrNamespaceDeclaration(t3);
              }
              break;
            case "namespace":
              if (this.tsCheckLineTerminator(s2) && this.match(Mi.name)) return this.tsParseModuleOrNamespaceDeclaration(t3);
              break;
            case "type":
              if (this.tsCheckLineTerminator(s2) && this.match(Mi.name)) return this.tsParseTypeAliasDeclaration(t3);
          }
        }
        ...
        tsIsDeclarationStart() {
          if (this.match(Mi.name)) switch (this.state.value) {
            case "abstract":
            case "declare":
            case "enum":
            case "interface":
        ...
        parseSubscript(t3, e2, s2, r2, i2) {
          ...
          if (this.isRelational("<")) {
            const a2 = this.tsTryParseAndCatch(() => {
              ...
              if (n2) {
                if (!r2 && this.eat(Mi.parenL)) return a3.arguments = this.parseCallExpressionArguments(Mi.parenR, false), this.tsCheckForInvalidTypeCasts(a3.arguments), a3.typeParameters = n2, i2.optionalChainMember && (a3.optional = false), this.finishCallExpression(a3, i2.optionalChainMember);
        ...
        parseImport(t3) {
          if (t3.importKind = "value", this.match(Mi.name) || this.match(Mi.star) || this.match(Mi.braceL)) {
            ...
            if (!this.isContextual("type") || e3.type === Mi.comma || e3.type === Mi.name && "from" === e3.value || e3.type === Mi.eq || (t3.importKind = "type", this.next(), e3 = this.lookahead()), this.match(Mi.name) && e3.type === Mi.eq) return this.tsParseImportEqualsDeclaration(t3);
          }
        ...
        parseExport(t3) {
          if (this.match(Mi._import)) return this.next(), this.isContextual("type") && 61 !== this.lookaheadCharCode() ? (t3.importKind = "type", this.next()) : t3.importKind = "value", this.tsParseImportEqualsDeclaration(t3, true);
          if (this.eat(Mi.eq)) {
            const e2 = t3;
        ...
        parseClassMemberWithIsStatic(t3, e2, s2, r2) {
          ...
          if (i2) return t3.body.push(i2), e2.abstract && this.raise(e2.start, Ha.IndexSignatureHasAbstract), e2.accessibility && this.raise(e2.start, Ha.IndexSignatureHasAccessibility, e2.accessibility), e2.declare && this.raise(e2.start, Ha.IndexSignatureHasDeclare), void (e2.override && this.raise(e2.start, Ha.IndexSignatureHasOverride));
        ...
        parseConditional(t3, e2, s2, r2) {
          if (!r2 || !this.match(Mi.question)) return super.parseConditional(t3, e2, s2, r2);
        ...
        parseExportDeclaration(t3) {
          ...
          if (r2 && (this.isContextual("declare") || !this.shouldParseExportDeclaration())) throw this.raise(this.state.start, Ha.ExpectedAmbientAfterExportDeclare);
          let i2;
        ...
        parseClassId(t3, e2, s2) {
          if ((!e2 || s2) && this.isContextual("implements")) return;
        ...
        parseMaybeAssign(...t3) {
          ...
          let u2, h2, c2, p2;
          if (this.hasPlugin("jsx") && (this.match(Mi.jsxTagStart) || this.isRelational("<"))) {
            if (u2 = this.state.clone(), h2 = this.tryParse(() => super.parseMaybeAssign(...t3), u2), !h2.error) return h2.node;
            const { context: e3 } = this.state;
            e3[e3.length - 1] === $i.j_oTag ? e3.length -= 2 : e3[e3.length - 1] === $i.j_expr && (e3.length -= 1);
          }
          if (!(null != (e2 = h2) && e2.error || this.isRelational("<"))) return super.parseMaybeAssign(...t3);
          ...
          if (!l2.error && !l2.aborted) return l2.node;
          if (!h2 && (Va(!this.hasPlugin("jsx")), c2 = this.tryParse(() => super.parseMaybeAssign(...t3), u2), !c2.error)) return c2.node;
          if (null != (s2 = h2) && s2.node) return this.state = h2.failState, h2.node;
          if (l2.node) return this.state = l2.failState, l2.node;
          if (null != (r2 = c2) && r2.node) return this.state = c2.failState, c2.node;
          if (null != (i2 = h2) && i2.thrown) throw h2.error;
          if (l2.thrown) throw l2.error;
          if (null != (a2 = c2) && a2.thrown) throw c2.error;
        ...
        tsParseAbstractDeclaration(t3) {
          if (this.match(Mi._class)) return t3.abstract = true, this.parseClass(t3, true, false);
          if (this.isContextual("interface")) {
            if (!this.hasFollowingLineBreak()) return t3.abstract = true, this.raise(t3.start, Ha.NonClassMethodPropertyHasAbstractModifer), this.next(), this.tsParseInterfaceDeclaration(t3);
          } else this.unexpected(null, Mi._class);
        }
        parseMethod(...t3) {
        ...
        parseV8Intrinsic() {
          if (this.match(Mi.modulo)) {
            ...
            if (this.eat(Mi.modulo), this.match(Mi.name)) {
              ...
              if (s2.type = "V8IntrinsicIdentifier", this.match(Mi.parenL)) return s2;
            }
            this.unexpected(t3);
          }
        }
        ...
        parseExpressionStatement(t3, e2) {
          if ("Placeholder" !== e2.type || e2.extra && e2.extra.parenthesized) return super.parseExpressionStatement(...arguments);
          if (this.match(Mi.colon)) {
            const s2 = t3;
        ...
        parseClass(t3, e2, s2) {
          ...
          if (a2) if (this.match(Mi._extends) || this.match(Mi.placeholder) || this.match(Mi.braceL)) t3.id = a2;
          else {
            if (s2 || !e2) return t3.id = null, t3.body = this.finishPlaceholder(a2, "ClassBody"), this.finishNode(t3, r2);
            this.unexpected(null, Wa.ClassNameIsRequired);
          }
          else this.parseClassId(t3, e2, s2);
        ...
        parseExport(t3) {
          ...
          if (!e2) return super.parseExport(...arguments);
          if (!this.isContextual("from") && !this.match(Mi.comma)) return t3.specifiers = [], t3.source = null, t3.declaration = this.finishPlaceholder(e2, "Declaration"), this.finishNode(t3, "ExportNamedDeclaration");
        ...
        isExportDefaultSpecifier() {
          if (this.match(Mi._default)) {
            const t3 = this.nextTokenStart();
            if (this.isUnparsedContextual(t3, "from") && this.input.startsWith(Mi.placeholder.label, this.nextTokenStartSince(t3 + 4))) return true;
          }
        ...
        parseImport(t3) {
          const e2 = this.parsePlaceholder("Identifier");
          if (!e2) return super.parseImport(...arguments);
          if (t3.specifiers = [], !this.isContextual("from") && !this.match(Mi.comma)) return t3.source = this.finishPlaceholder(e2, "StringLiteral"), this.semicolon(), this.finishNode(t3, "ImportDeclaration");
          const s2 = this.startNodeAtNode(e2);
      ...
      class on {
        ...
        exit() {
          ...
          for (const [s2, r2] of Array.from(t2.undefinedPrivateNames)) e2 ? e2.undefinedPrivateNames.has(s2) || e2.undefinedPrivateNames.set(s2, r2) : this.raise(r2, Gi.InvalidPrivateFieldResolution, s2);
        }
        declarePrivateName(t2, e2, s2) {
          ...
          if (3 & e2) {
            ...
            } else i2 || r2.loneAccessors.set(t2, e2);
          }
        ...
        usePrivateName(t2, e2) {
          let s2;
          for (s2 of this.stack) if (s2.privateNames.has(t2)) return;
      ...
      class cn {
        ...
        recordParenthesizedIdentifierError(t2, e2) {
          ...
          if (r2.isCertainlyParameterDeclaration()) this.raise(t2, e2);
          else {
            if (!r2.canBeArrowParameterDeclaration()) return;
        ...
        recordAsyncArrowParametersError(t2, e2) {
          const { stack: s2 } = this;
          let r2 = s2.length - 1, i2 = s2[r2];
          for (; i2.canBeArrowParameterDeclaration(); ) 2 === i2.type && i2.recordDeclarationError(t2, e2), i2 = s2[--r2];
        }
        validateAsPattern() {
          ...
          e2.canBeArrowParameterDeclaration() && e2.iterateErrors((e3, s2) => {
            ...
            for (; i2.canBeArrowParameterDeclaration(); ) i2.clearDeclarationError(s2), i2 = t2[--r2];
          });
        }
      }
      function pn() {
      ...
      class An extends class extends class extends class extends class extends class extends class extends class extends class extends class {
        ...
        getPluginOption(t2, e2) {
          if (this.hasPlugin(t2)) return this.plugins.get(t2)[e2];
        }
      } {
        addComment(t2) {
        ...
        adjustCommentsAfterTrailingComma(t2, e2, s2) {
          ...
          for (; null === r2 && i2 > 0; ) r2 = e2[--i2];
          if (null === r2) return;
          for (let t3 = 0; t3 < this.state.leadingComments.length; t3++) this.state.leadingComments[t3].end < this.state.commentPreviousNode.end && (this.state.leadingComments.splice(t3, 1), t3--);
          const a2 = [];
        ...
        processComment(t2) {
          if ("Program" === t2.type && t2.body.length > 0) return;
          const e2 = this.state.commentStack;
          let s2, r2, i2, a2, n2;
          if (this.state.trailingComments.length > 0) this.state.trailingComments[0].start >= t2.end ? (i2 = this.state.trailingComments, this.state.trailingComments = []) : this.state.trailingComments.length = 0;
          else if (e2.length > 0) {
            const s3 = zi(e2);
            s3.trailingComments && s3.trailingComments[0].start >= t2.end && (i2 = s3.trailingComments, delete s3.trailingComments);
          }
          for (e2.length > 0 && zi(e2).start >= t2.start && (s2 = e2.pop()); e2.length > 0 && zi(e2).start >= t2.start; ) r2 = e2.pop();
          if (!r2 && s2 && (r2 = s2), s2) switch (t2.type) {
            case "ObjectExpression":
          ...
          else this.state.commentPreviousNode && ("ImportSpecifier" === this.state.commentPreviousNode.type && "ImportSpecifier" !== t2.type || "ExportSpecifier" === this.state.commentPreviousNode.type && "ExportSpecifier" !== t2.type) && this.adjustCommentsAfterTrailingComma(t2, [this.state.commentPreviousNode]);
          if (r2) {
            if (r2.leadingComments) {
              if (r2 !== t2 && r2.leadingComments.length > 0 && zi(r2.leadingComments).end <= t2.start) t2.leadingComments = r2.leadingComments, delete r2.leadingComments;
              else for (a2 = r2.leadingComments.length - 2; a2 >= 0; --a2) if (r2.leadingComments[a2].end <= t2.start) {
                t2.leadingComments = r2.leadingComments.splice(0, a2 + 1);
                break;
              }
            }
          } else if (this.state.leadingComments.length > 0) if (zi(this.state.leadingComments).end <= t2.start) {
            if (this.state.commentPreviousNode) for (n2 = 0; n2 < this.state.leadingComments.length; n2++) this.state.leadingComments[n2].end < this.state.commentPreviousNode.end && (this.state.leadingComments.splice(n2, 1), n2--);
          ...
          if (this.state.commentPreviousNode = t2, i2) if (i2.length && i2[0].start >= t2.start && zi(i2).end <= t2.end) t2.innerComments = i2;
          else {
        ...
        getLocationForPosition(t2) {
          ...
          return e2 = t2 === this.state.start ? this.state.startLoc : t2 === this.state.lastTokStart ? this.state.lastTokStartLoc : t2 === this.state.end ? this.state.endLoc : t2 === this.state.lastTokEnd ? this.state.lastTokEndLoc : function(t3, e3) {
            let s2, r2 = 1, i2 = 0;
            for (ji.lastIndex = 0; (s2 = ji.exec(t3)) && s2.index < e3; ) r2++, i2 = ji.lastIndex;
        ...
        raiseOverwrite(t2, { code: e2, template: s2 }, ...r2) {
          ...
          if (this.options.errorRecovery) {
            ...
            for (let s3 = e3.length - 1; s3 >= 0; s3--) {
              const r3 = e3[s3];
              if (r3.pos === t2) return Object.assign(r3, { message: a2 });
              if (r3.pos < t2) break;
            }
          }
        ...
        _raise(t2, e2) {
          ...
          if (Object.assign(s2, t2), this.options.errorRecovery) return this.isLookahead || this.state.errors.push(s2), s2;
          throw s2;
        }
      } {
        constructor(t2, e2) {
        ...
        nextToken() {
          ...
          if (null != t2 && t2.preserveSpace || this.skipSpace(), this.state.start = this.state.pos, this.state.startLoc = this.state.curPosition(), this.state.pos >= this.length) return void this.finishToken(Mi.eof);
        ...
        skipBlockComment() {
          ...
          if (-1 === s2) throw this.raise(e2, Gi.UnterminatedComment);
          let r2;
          for (this.state.pos = s2 + 2, ji.lastIndex = e2; (r2 = ji.exec(this.input)) && r2.index < this.state.pos; ) ++this.state.curLine, this.state.lineStart = r2.index + r2[0].length;
        ...
        skipLineComment(t2) {
          ...
          if (this.state.pos < this.length) for (; !_i(r2) && ++this.state.pos < this.length; ) r2 = this.input.charCodeAt(this.state.pos);
        ...
        readToken_numberSign() {
          ...
          if (e2 >= 48 && e2 <= 57) throw this.raise(this.state.pos, Gi.UnexpectedDigitAfterHash);
          if (123 === e2 || 91 === e2 && this.hasPlugin("recordAndTuple")) {
            if (this.expectPlugin("recordAndTuple"), "hash" !== this.getPluginOption("recordAndTuple", "syntaxType")) throw this.raise(this.state.pos, 123 === e2 ? Gi.RecordExpressionHashIncorrectStartSyntaxType : Gi.TupleExpressionHashIncorrectStartSyntaxType);
            123 === e2 ? this.finishToken(Mi.braceHashL) : this.finishToken(Mi.bracketHashL), this.state.pos += 2;
          } else this.finishOp(Mi.hash, 1);
        }
        readToken_dot() {
        ...
        readToken_interpreter() {
          ...
          if (33 !== t2) return false;
          const e2 = this.state.pos;
          for (this.state.pos += 1; !_i(t2) && ++this.state.pos < this.length; ) t2 = this.input.charCodeAt(this.state.pos);
        ...
        readToken_pipe_amp(t2) {
          ...
          if (e2 !== t2) {
            if (124 === t2) {
              if (62 === e2) return void this.finishOp(Mi.pipeline, 2);
              if (this.hasPlugin("recordAndTuple") && 125 === e2) {
                if ("bar" !== this.getPluginOption("recordAndTuple", "syntaxType")) throw this.raise(this.state.pos, Gi.RecordExpressionBarIncorrectEndSyntaxType);
                return void this.finishOp(Mi.braceBarR, 2);
              }
              if (this.hasPlugin("recordAndTuple") && 93 === e2) {
                if ("bar" !== this.getPluginOption("recordAndTuple", "syntaxType")) throw this.raise(this.state.pos, Gi.TupleExpressionBarIncorrectEndSyntaxType);
          ...
          } else 61 === this.input.charCodeAt(this.state.pos + 2) ? this.finishOp(Mi.assign, 3) : this.finishOp(124 === t2 ? Mi.logicalOR : Mi.logicalAND, 2);
        }
        readToken_caret() {
        ...
        readToken_plus_min(t2) {
          const e2 = this.input.charCodeAt(this.state.pos + 1);
          if (e2 === t2) return 45 !== e2 || this.inModule || 62 !== this.input.charCodeAt(this.state.pos + 2) || 0 !== this.state.lastTokEnd && !this.hasPrecedingLineBreak() ? void this.finishOp(Mi.incDec, 2) : (this.skipLineComment(3), this.skipSpace(), void this.nextToken());
        ...
        readToken_eq_excl(t2) {
          const e2 = this.input.charCodeAt(this.state.pos + 1);
          if (61 !== e2) return 61 === t2 && 62 === e2 ? (this.state.pos += 2, void this.finishToken(Mi.arrow)) : void this.finishOp(61 === t2 ? Mi.eq : Mi.bang, 1);
          ...
          switch (t2) {
            ...
            case 91:
              if (this.hasPlugin("recordAndTuple") && 124 === this.input.charCodeAt(this.state.pos + 1)) {
                if ("bar" !== this.getPluginOption("recordAndTuple", "syntaxType")) throw this.raise(this.state.pos, Gi.TupleExpressionBarIncorrectStartSyntaxType);
                this.finishToken(Mi.bracketBarL), this.state.pos += 2;
              } else ++this.state.pos, this.finishToken(Mi.bracketL);
              return;
            case 93:
              return ++this.state.pos, void this.finishToken(Mi.bracketR);
            case 123:
              if (this.hasPlugin("recordAndTuple") && 124 === this.input.charCodeAt(this.state.pos + 1)) {
                if ("bar" !== this.getPluginOption("recordAndTuple", "syntaxType")) throw this.raise(this.state.pos, Gi.RecordExpressionBarIncorrectStartSyntaxType);
                this.finishToken(Mi.braceBarL), this.state.pos += 2;
              } else ++this.state.pos, this.finishToken(Mi.braceL);
              return;
            case 125:
            ...
            default:
              if (ia(t2)) return void this.readWord();
          }
        ...
        readRegexp() {
          ...
          let e2, s2;
          for (; ; ) {
            if (this.state.pos >= this.length) throw this.raise(t2, Gi.UnterminatedRegExp);
            const r3 = this.input.charAt(this.state.pos);
            if (Ri.test(r3)) throw this.raise(t2, Gi.UnterminatedRegExp);
            if (e2) e2 = false;
            else {
              if ("[" === r3) s2 = true;
              else if ("]" === r3 && s2) s2 = false;
              else if ("/" === r3 && !s2) break;
              e2 = "\\" === r3;
            }
            ++this.state.pos;
          ...
          for (; this.state.pos < this.length; ) {
            ...
            if (en.has(t3)) i2.indexOf(t3) > -1 && this.raise(this.state.pos + 1, Gi.DuplicateRegExpFlags);
            else {
              if (!aa(e3) && 92 !== e3) break;
        ...
        readInt(t2, e2, s2, r2 = true) {
          ...
          for (let i3 = 0, h2 = null == e2 ? 1 / 0 : e2; i3 < h2; ++i3) {
            ...
            let h3;
            if (95 !== e3) {
              if (h3 = e3 >= 97 ? e3 - 97 + 10 : e3 >= 65 ? e3 - 65 + 10 : tn(e3) ? e3 - 48 : 1 / 0, h3 >= t2) if (this.options.errorRecovery && h3 <= 9) h3 = 0, this.raise(this.state.start + i3 + 2, Gi.InvalidDigit, t2);
              else {
                if (!s2) break;
                h3 = 0, o2 = true;
              }
        ...
        readRadixNumber(t2) {
          ...
          if (110 === i2) ++this.state.pos, s2 = true;
          else if (109 === i2) throw this.raise(e2, Gi.InvalidDecimal);
          if (ia(this.input.codePointAt(this.state.pos))) throw this.raise(this.state.pos, Gi.NumberIdentifier);
          if (s2) {
            const t3 = this.input.slice(e2, this.state.pos).replace(/[_n]/g, "");
            this.finishToken(Mi.bigint, t3);
          } else this.finishToken(Mi.num, r2);
        }
        readNumber(t2) {
          const e2 = this.state.pos;
        ...
        readCodePoint(t2) {
          ...
          } else e2 = this.readHexChar(4, false, t2);
          return e2;
        }
        readString(t2) {
          let e2 = "", s2 = ++this.state.pos;
          for (; ; ) {
            ...
            const r2 = this.input.charCodeAt(this.state.pos);
            if (r2 === t2) break;
            if (92 === r2) e2 += this.input.slice(s2, this.state.pos), e2 += this.readEscapedChar(false), s2 = this.state.pos;
            else if (8232 === r2 || 8233 === r2) ++this.state.pos, ++this.state.curLine, this.state.lineStart = this.state.pos;
            else {
              if (_i(r2)) throw this.raise(this.state.start, Gi.UnterminatedString);
              ++this.state.pos;
            }
          }
        ...
        readTmplToken() {
          ...
          for (; ; ) {
            if (this.state.pos >= this.length) throw this.raise(this.state.start, Gi.UnterminatedTemplate);
            const r2 = this.input.charCodeAt(this.state.pos);
            if (96 === r2 || 36 === r2 && 123 === this.input.charCodeAt(this.state.pos + 1)) return this.state.pos === this.state.start && this.match(Mi.template) ? 36 === r2 ? (this.state.pos += 2, void this.finishToken(Mi.dollarBraceL)) : (++this.state.pos, void this.finishToken(Mi.backQuote)) : (t2 += this.input.slice(e2, this.state.pos), void this.finishToken(Mi.template, s2 ? null : t2));
            if (92 === r2) {
        ...
        readWord1() {
          ...
          for (; this.state.pos < this.length; ) {
            ...
            if (aa(r2)) this.state.pos += r2 <= 65535 ? 1 : 2;
            else if (this.state.isIterator && 64 === r2) ++this.state.pos;
            else {
              if (92 !== r2) break;
              {
        ...
        expectPlugin(t2, e2) {
          if (!this.hasPlugin(t2)) throw this.raiseWithData(null != e2 ? e2 : this.state.start, { missingPlugin: [t2] }, "This experimental syntax requires enabling the parser plugin: '".concat(t2, "'"));
          return true;
        }
        expectOnePlugin(t2, e2) {
          if (!t2.some((t3) => this.hasPlugin(t3))) throw this.raiseWithData(null != e2 ? e2 : this.state.start, { missingPlugin: t2 }, "This experimental syntax requires enabling one of the following parser plugin(s): '".concat(t2.join(", "), "'"));
        }
        tryParse(t2, e2 = this.state.clone()) {
          ...
          try {
            ...
            const r2 = this.state;
            if (this.state = e2, t3 instanceof SyntaxError) return { node: null, error: t3, thrown: true, aborted: false, failState: r2 };
            if (t3 === s2) return { node: s2.node, error: null, thrown: false, aborted: true, failState: r2 };
            throw t3;
          }
        }
        ...
        toAssignableObjectExpressionProp(t2, e2, s2) {
          ...
          } else "SpreadElement" !== t2.type || e2 ? this.toAssignable(t2, s2) : this.raiseRestNotLast(t2.start);
        }
        toAssignableList(t2, e2, s2) {
          let r2 = t2.length;
          if (r2) {
            const i2 = t2[r2 - 1];
            if ("RestElement" === (null == i2 ? void 0 : i2.type)) --r2;
        ...
        toReferencedListDeep(t2, e2) {
          ...
          for (const e3 of t2) "ArrayExpression" === (null == e3 ? void 0 : e3.type) && this.toReferencedListDeep(e3.elements);
        }
        parseSpread(t2, e2) {
          const s2 = this.startNode();
        ...
        parseBindingList(t2, e2, s2, r2) {
          const i2 = [];
          let a2 = true;
          for (; !this.eat(t2); ) if (a2 ? a2 = false : this.expect(Mi.comma), s2 && this.match(Mi.comma)) i2.push(null);
          else {
            if (this.eat(t2)) break;
            ...
            {
              const t3 = [];
              for (this.match(Mi.at) && this.hasPlugin("decorators") && this.raise(this.state.start, Gi.UnsupportedParameterDecorator); this.match(Mi.at); ) t3.push(this.parseDecorator());
        ...
        parseMaybeDefault(t2, e2, s2) {
          var r2, i2, a2;
          if (e2 = null != (r2 = e2) ? r2 : this.state.startLoc, t2 = null != (i2 = t2) ? i2 : this.state.start, s2 = null != (a2 = s2) ? a2 : this.parseBindingAtom(), !this.eat(Mi.eq)) return s2;
          ...
          switch (t2.type) {
            ...
            case "ObjectPattern":
              for (let e3 of t2.properties) {
                if (this.isObjectProperty(e3)) e3 = e3.value;
                else if (this.isObjectMethod(e3)) continue;
                this.checkLVal(e3, "object destructuring pattern", s2, r2, i2);
              }
              break;
            case "ArrayPattern":
              for (const e3 of t2.elements) e3 && this.checkLVal(e3, "array destructuring pattern", s2, r2, i2);
              break;
            case "AssignmentPattern":
        ...
        checkProto(t2, e2, s2, r2) {
          if ("SpreadElement" === t2.type || this.isObjectMethod(t2) || t2.computed || t2.shorthand) return;
          const i2 = t2.key;
          if ("__proto__" === ("Identifier" === i2.type ? i2.name : i2.value)) {
            if (e2) return void this.raise(i2.start, Gi.RecordNoProto);
        ...
        parseExpressionBase(t2) {
          ...
          if (this.match(Mi.comma)) {
            const i2 = this.startNodeAt(e2, s2);
            for (i2.expressions = [r2]; this.eat(Mi.comma); ) i2.expressions.push(this.parseMaybeAssign(t2));
        ...
        parseExprOp(t2, e2, s2, r2) {
          ...
          if (null != i2 && (this.prodParam.hasIn || !this.match(Mi._in)) && i2 > r2) {
            ...
            if (a2 === Mi.pipeline) {
              if (this.expectPlugin("pipelineOperator"), this.state.inFSharpPipelineDirectBody) return t2;
            ...
            if (u2 && (i2 = Mi.logicalAND.binop), this.next(), a2 === Mi.pipeline && "minimal" === this.getPluginOption("pipelineOperator", "proposal") && this.match(Mi.name) && "await" === this.state.value && this.prodParam.hasAwait) throw this.raise(this.state.start, Gi.UnexpectedAwaitAfterPipelineBody);
            ...
            if (u2 && (h2 === Mi.logicalOR || h2 === Mi.logicalAND) || o2 && h2 === Mi.nullishCoalescing) throw this.raise(this.state.start, Gi.MixingCoalesceWithLogical);
        ...
        parseMaybeUnary(t2, e2) {
          ...
          if (this.state.type.prefix) {
            ...
            if (!a2) return e2 || this.checkExponentialAfterUnary(n2), this.finishNode(n2, "UnaryExpression");
          }
          const o2 = this.parseUpdate(n2, a2, t2);
          if (i2) {
            if ((this.hasPlugin("v8intrinsic") ? this.state.type.startsExpr : this.state.type.startsExpr && !this.match(Mi.modulo)) && !this.isAmbiguousAwait()) return this.raiseOverwrite(s2, this.hasPlugin("topLevelAwait") ? Gi.AwaitNotInAsyncContext : Gi.AwaitNotInAsyncFunction), this.parseAwait(s2, r2);
          }
          return o2;
        }
        parseUpdate(t2, e2, s2) {
          if (e2) return this.checkLVal(t2.argument, "prefix operation"), this.finishNode(t2, "UpdateExpression");
          const r2 = this.state.start, i2 = this.state.startLoc;
          let a2 = this.parseExprSubscripts(s2);
          if (this.checkExpressionErrors(s2, false)) return a2;
        ...
        parseSubscript(t2, e2, s2, r2, i2) {
          if (!r2 && this.eat(Mi.doubleColon)) return this.parseBind(t2, e2, s2, r2, i2);
          if (this.match(Mi.backQuote)) return this.parseTaggedTemplateExpression(t2, e2, s2, i2);
          let a2 = false;
          if (this.match(Mi.questionDot)) {
            if (r2 && 40 === this.lookaheadCharCode()) return i2.stop = true, t2;
        ...
        finishCallExpression(t2, e2) {
          if ("Import" === t2.callee.type) if (2 === t2.arguments.length && (this.hasPlugin("moduleAttributes") || this.expectPlugin("importAssertions")), 0 === t2.arguments.length || t2.arguments.length > 2) this.raise(t2.start, Gi.ImportCallArity, this.hasPlugin("importAssertions") || this.hasPlugin("moduleAttributes") ? "one or two arguments" : "one argument");
          else for (const e3 of t2.arguments) "SpreadElement" === e3.type && this.raise(e3.start, Gi.ImportCallSpreadArgument);
        ...
        parseExprAtom(t2) {
          ...
          switch (this.state.type) {
            ...
            case Mi.name: {
              ...
              if (!t3 && "async" === s3.name && !this.canInsertSemicolon()) {
                if (this.match(Mi._function)) {
                  ...
                  if (this.state.context[t4] !== $i.functionStatement) throw new Error("Internal error");
                  return this.state.context[t4] = $i.functionExpression, this.next(), this.parseFunction(this.startNodeAtNode(s3), void 0, true);
                }
                if (this.match(Mi.name)) return 61 === this.lookaheadCharCode() ? this.parseAsyncArrowUnaryFunction(s3) : s3;
                if (this.match(Mi._do)) return this.parseDo(true);
              }
            ...
            case Mi.doubleColon: {
              ...
              if ("MemberExpression" === t3.type) return this.finishNode(s2, "BindExpression");
              throw this.raise(t3.start, Gi.UnsupportedBind);
            }
            case Mi.hash: {
              if (this.state.inPipeline) return s2 = this.startNode(), "smart" !== this.getPluginOption("pipelineOperator", "proposal") && this.raise(s2.start, Gi.PrimaryTopicRequiresSmartPipeline), this.next(), this.primaryTopicReferenceIsAllowedInCurrentTopicContext() || this.raise(s2.start, Gi.PrimaryTopicNotAllowed), this.registerTopicReference(), this.finishNode(s2, "PipelinePrimaryTopicReference");
              const t3 = this.input.codePointAt(this.state.end);
              if (ia(t3) || 92 === t3) {
                const t4 = this.state.start;
                if (s2 = this.parseMaybePrivateName(true), this.match(Mi._in)) this.expectPlugin("privateIn"), this.classScope.usePrivateName(this.getPrivateNameSV(s2), s2.start);
                else {
                  if (!this.hasPlugin("privateIn")) throw this.unexpected(t4);
        ...
        parseParenAndDistinguishExpression(t2) {
          ...
          if (t2 && this.shouldParseArrow() && (f2 = this.parseArrow(f2))) return this.expressionScope.validateAsPattern(), this.expressionScope.exit(), this.parseArrowExpression(f2, u2, false), f2;
        ...
        parseArrow(t2) {
          if (this.eat(Mi.arrow)) return t2;
        }
        ...
        parseTemplate(t2) {
          ...
          for (e2.quasis = [s2]; !s2.tail; ) this.expect(Mi.dollarBraceL), e2.expressions.push(this.parseTemplateSubstitution()), this.expect(Mi.braceR), e2.quasis.push(s2 = this.parseTemplateElement(t2));
        ...
        parsePropertyDefinition(t2, e2) {
          let s2 = [];
          if (this.match(Mi.at)) for (this.hasPlugin("decorators") && this.raise(this.state.start, Gi.UnsupportedPropertyDecorator); this.match(Mi.at); ) s2.push(this.parseDecorator());
          const r2 = this.startNode();
          let i2, a2, n2 = false, o2 = false, u2 = false;
          if (this.match(Mi.ellipsis)) return s2.length && this.unexpected(), t2 ? (this.next(), r2.argument = this.parseIdentifier(), this.checkCommaAfterRest(125), this.finishNode(r2, "RestElement")) : this.parseSpread();
        ...
        parsePropertyName(t2, e2) {
          if (this.eat(Mi.bracketL)) t2.computed = true, t2.key = this.parseMaybeAssignAllowIn(), this.expect(Mi.bracketR);
          else {
        ...
        parseFunctionBody(t2, e2, s2 = false) {
          ...
          if (this.expressionScope.enter(pn()), r2) t2.body = this.parseMaybeAssign(), this.checkParams(t2, false, e2, false);
          else {
        ...
        isSimpleParamList(t2) {
          for (let e2 = 0, s2 = t2.length; e2 < s2; e2++) if ("Identifier" !== t2[e2].type) return false;
          return true;
        }
        checkParams(t2, e2, s2, r2 = true) {
          const i2 = /* @__PURE__ */ new Set();
          for (const s3 of t2.params) this.checkLVal(s3, "function parameter list", 5, e2 ? null : i2, void 0, r2);
        }
        ...
        parseExprListItem(t2, e2, s2, r2) {
          let i2;
          if (this.match(Mi.comma)) t2 || this.raise(this.state.pos, Gi.UnexpectedToken, ","), i2 = null;
          ...
          } else i2 = this.parseMaybeAssignAllowIn(e2, this.parseParenItem, s2);
          return i2;
        }
        parseIdentifier(t2) {
        ...
        parseIdentifierName(t2, e2) {
          ...
          if (i2 === Mi.name) s2 = this.state.value;
          else {
            if (!i2.keyword) throw this.unexpected();
            {
              s2 = i2.keyword;
        ...
        checkReservedWord(t2, e2, s2, r2) {
          if (this.prodParam.hasYield && "yield" === t2) return void this.raise(e2, Gi.YieldBindingIdentifier);
          if ("await" === t2) {
            if (this.prodParam.hasAwait) return void this.raise(e2, Gi.AwaitBindingIdentifier);
            if (this.scope.inStaticBlock && !this.scope.inNonArrowFunction) return void this.raise(e2, Gi.AwaitBindingIdentifierInStaticBlock);
            this.expressionScope.recordAsyncArrowParametersError(e2, Gi.AwaitBindingIdentifier);
          }
          if (this.scope.inClass && !this.scope.inNonArrowFunction && "arguments" === t2) return void this.raise(e2, Gi.ArgumentsInClass);
          if (s2 && ma(t2)) return void this.raise(e2, Gi.UnexpectedKeyword, t2);
        ...
        checkSmartPipelineBodyEarlyErrors(t2, e2) {
          if (this.match(Mi.arrow)) throw this.raise(this.state.start, Gi.PipelineBodyNoArrow);
        ...
        parseProgram(t2, e2 = Mi.eof, s2 = this.options.sourceType) {
          if (t2.sourceType = s2, t2.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(t2, true, true, e2), this.inModule && !this.options.allowUndeclaredExports && this.scope.undefinedExports.size > 0) for (const [t3] of Array.from(this.scope.undefinedExports)) {
        ...
        parseInterpreterDirective() {
          if (!this.match(Mi.interpreterDirective)) return null;
          const t2 = this.startNode();
        ...
        isLetKeyword(t2) {
          ...
          if (91 === s2) return true;
          if (t2) return false;
          if (123 === s2) return true;
          if (ia(s2)) {
            let t3 = e2 + 1;
            for (; aa(this.input.charCodeAt(t3)); ) ++t3;
            const s3 = this.input.slice(e2, t3);
            if (!fa.test(s3)) return true;
          }
          return false;
        }
        ...
        parseStatementContent(t2, e2) {
          ...
          switch (this.isLet(t2) && (s2 = Mi._var, i2 = "let"), s2) {
            ...
            default:
              if (this.isAsyncFunction()) return t2 && this.raise(this.state.start, Gi.AsyncFunctionInSingleStatementContext), this.next(), this.parseFunctionStatement(r2, true, !t2);
          }
        ...
        parseDecorators(t2) {
          ...
          if (this.match(Mi._export)) t2 || this.unexpected(), this.hasPlugin("decorators") && !this.getPluginOption("decorators", "decoratorsBeforeExport") && this.raise(this.state.start, Gi.DecoratorExportClass);
          else if (!this.canHaveLeadingDecorator()) throw this.raise(this.state.start, Gi.UnexpectedLeadingDecorator);
        }
        parseDecorator() {
          ...
          if (this.next(), this.hasPlugin("decorators")) {
            ...
            const e2 = this.state.start, s2 = this.state.startLoc;
            let r2;
            if (this.eat(Mi.parenL)) r2 = this.parseExpression(), this.expect(Mi.parenR);
            else for (r2 = this.parseIdentifier(false); this.eat(Mi.dot); ) {
          ...
          } else t2.expression = this.parseExprSubscripts();
        ...
        verifyBreakContinue(t2, e2) {
          ...
          for (r2 = 0; r2 < this.state.labels.length; ++r2) {
            ...
            if (null == t2.label || e3.name === t2.label.name) {
              if (null != e3.kind && (s2 || "loop" === e3.kind)) break;
              if (t2.label && s2) break;
            }
          }
        ...
        parseForStatement(t2) {
          ...
          let e2 = -1;
          if (this.isAwaitAllowed() && this.eatContextual("await") && (e2 = this.state.lastTokStart), this.scope.enter(0), this.expect(Mi.parenL), this.match(Mi.semi)) return e2 > -1 && this.unexpected(e2), this.parseFor(t2, null);
        ...
        parseSwitchStatement(t2) {
          ...
          const e2 = t2.cases = [];
          let s2, r2;
          for (this.expect(Mi.braceL), this.state.labels.push(fn), this.scope.enter(0); !this.match(Mi.braceR); ) if (this.match(Mi._case) || this.match(Mi._default)) {
          ...
          } else s2 ? s2.consequent.push(this.parseStatement(null)) : this.unexpected();
        ...
        parseLabeledStatement(t2, e2, s2, r2) {
          for (const t3 of this.state.labels) t3.name === e2 && this.raise(s2.start, Gi.LabelRedeclaration, e2);
          ...
          for (let e3 = this.state.labels.length - 1; e3 >= 0; e3--) {
            ...
            if (s3.statementStart !== t2.start) break;
        ...
        parseVar(t2, e2, s2) {
          ...
          for (t2.kind = s2; ; ) {
            const t3 = this.startNode();
            if (this.parseVarId(t3, s2), this.eat(Mi.eq) ? t3.init = e2 ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn() : ("const" !== s2 || this.match(Mi._in) || this.isContextual("of") ? "Identifier" === t3.id.type || e2 && (this.match(Mi._in) || this.isContextual("of")) || this.raise(this.state.lastTokEnd, Gi.DeclarationMissingInitializer, "Complex binding patterns") : i2 || this.raise(this.state.lastTokEnd, Gi.DeclarationMissingInitializer, "Const declarations"), t3.init = null), r2.push(this.finishNode(t3, "VariableDeclarator")), !this.eat(Mi.comma)) break;
          }
          return t2;
        }
        parseVarId(t2, e2) {
        ...
        parseClassBody(t2, e2) {
          ...
          if (i2.body = [], this.expect(Mi.braceL), this.withTopicForbiddingContext(() => {
            for (; !this.match(Mi.braceR); ) {
              if (this.eat(Mi.semi)) {
                if (r2.length > 0) throw this.raise(this.state.lastTokEnd, Gi.DecoratorSemicolon);
                continue;
              }
              if (this.match(Mi.at)) {
          ...
          }), this.state.strict = e2, this.next(), r2.length) throw this.raise(this.state.start, Gi.TrailingDecorator);
        ...
        parseClassMember(t2, e2, s2) {
          ...
          if (r2) {
            if (this.parseClassMemberFromModifier(t2, e2)) return;
            if (this.eat(Mi.braceL)) return void this.parseClassStaticBlock(t2, e2);
          }
        ...
        parseClassMemberWithIsStatic(t2, e2, s2, r2) {
          ...
          if (e2.static = r2, this.eat(Mi.star)) return u2.kind = "method", this.parseClassElementName(u2), this.isPrivateName(u2.key) ? void this.pushClassPrivateMethod(t2, a2, true, false) : (this.isNonstaticConstructor(i2) && this.raise(i2.key.start, Gi.ConstructorIsGenerator), void this.pushClassMethod(t2, i2, true, false, false, false));
          ...
          if (this.parsePostMemberNameModifiers(h2), this.isClassMethod()) {
            if (u2.kind = "method", l2) return void this.pushClassPrivateMethod(t2, a2, false, false);
          ...
          } else if (this.isClassProperty()) l2 ? this.pushClassPrivateProperty(t2, o2) : this.pushClassProperty(t2, n2);
          else if (!d2 || "async" !== p2.name || c2 || this.isLineTerminator()) !d2 || "get" !== p2.name && "set" !== p2.name || c2 || this.match(Mi.star) && this.isLineTerminator() ? this.isLineTerminator() ? l2 ? this.pushClassPrivateProperty(t2, o2) : this.pushClassProperty(t2, n2) : this.unexpected() : (u2.kind = p2.name, this.parseClassElementName(i2), this.isPrivateName(u2.key) ? this.pushClassPrivateMethod(t2, a2, false, false) : (this.isNonstaticConstructor(i2) && this.raise(i2.key.start, Gi.ConstructorIsAccessor), this.pushClassMethod(t2, i2, false, false, false, false)), this.checkGetterSetterParams(i2));
          else {
        ...
        parseExport(t2) {
          ...
          if (r2 && !i2) return e2 && this.unexpected(), this.parseExportFrom(t2, true), this.finishNode(t2, "ExportAllDeclaration");
          const o2 = this.maybeParseExportNamedSpecifiers(t2);
          if (e2 && s2 && !r2 && !o2 || i2 && a2 && !o2) throw this.unexpected(null, Mi.braceL);
          let u2;
          if (n2 || o2 ? (u2 = false, this.parseExportFrom(t2, n2)) : u2 = this.maybeParseExportDeclaration(t2), n2 || o2 || u2) return this.checkExport(t2, true, false, !!t2.source), this.finishNode(t2, "ExportNamedDeclaration");
          if (this.eat(Mi._default)) return t2.declaration = this.parseExportDefaultExpression(), this.checkExport(t2, true, true), this.finishNode(t2, "ExportDefaultDeclaration");
        ...
        parseExportDefaultExpression() {
          ...
          if (this.match(Mi._function) || e2) return this.next(), e2 && this.next(), this.parseFunction(t2, 5, e2);
          if (this.match(Mi._class)) return this.parseClass(t2, true, true);
          if (this.match(Mi.at)) return this.hasPlugin("decorators") && this.getPluginOption("decorators", "decoratorsBeforeExport") && this.raise(this.state.start, Gi.DecoratorBeforeExport), this.parseDecorators(false), this.parseClass(t2, true, true);
          if (this.match(Mi._const) || this.match(Mi._var) || this.isLet()) throw this.raise(this.state.start, Gi.UnsupportedDefaultExport);
          {
        ...
        isExportDefaultSpecifier() {
          if (this.match(Mi.name)) {
            const t3 = this.state.value;
            if ("async" === t3 && !this.state.containsEsc || "let" === t3) return false;
            if (("type" === t3 || "interface" === t3) && !this.state.containsEsc) {
              const t4 = this.lookahead();
              if (t4.type === Mi.name && "from" !== t4.value || t4.type === Mi.braceL) return this.expectOnePlugin(["flow", "typescript"]), false;
            }
          } else if (!this.match(Mi._default)) return false;
          const t2 = this.nextTokenStart(), e2 = this.isUnparsedContextual(t2, "from");
          if (44 === this.input.charCodeAt(t2) || this.match(Mi.name) && e2) return true;
        ...
        parseExportFrom(t2, e2) {
          if (this.eatContextual("from")) {
            ...
            e3 && (t2.assertions = e3);
          } else e2 ? this.unexpected() : t2.source = null;
          this.semicolon();
        }
        shouldParseExportDeclaration() {
        ...
        checkExport(t2, e2, s2, r2) {
          if (e2) {
            if (s2) {
            ...
            } else if (t2.specifiers && t2.specifiers.length) for (const e3 of t2.specifiers) {
              ...
              if ("FunctionDeclaration" === t2.declaration.type || "ClassDeclaration" === t2.declaration.type) {
                ...
                if (!e3) throw new Error("Assertion failure");
                this.checkDuplicateExports(t2, e3.name);
              } else if ("VariableDeclaration" === t2.declaration.type) for (const e3 of t2.declaration.declarations) this.checkDeclaration(e3.id);
            }
          }
          if (this.state.decoratorStack[this.state.decoratorStack.length - 1].length) throw this.raise(t2.start, Gi.UnsupportedDecoratorExport);
        }
        checkDeclaration(t2) {
          if ("Identifier" === t2.type) this.checkDuplicateExports(t2, t2.name);
          else if ("ObjectPattern" === t2.type) for (const e2 of t2.properties) this.checkDeclaration(e2);
          else if ("ArrayPattern" === t2.type) for (const e2 of t2.elements) e2 && this.checkDeclaration(e2);
          else "ObjectProperty" === t2.type ? this.checkDeclaration(t2.value) : "RestElement" === t2.type ? this.checkDeclaration(t2.argument) : "AssignmentPattern" === t2.type && this.checkDeclaration(t2.left);
        }
        ...
        parseExportSpecifiers() {
          ...
          for (this.expect(Mi.braceL); !this.eat(Mi.braceR); ) {
            if (e2) e2 = false;
            else if (this.expect(Mi.comma), this.eat(Mi.braceR)) break;
            const s2 = this.startNode();
        ...
        parseAssertEntries() {
          ...
          do {
            if (this.match(Mi.braceR)) break;
            const s2 = this.startNode(), r2 = this.state.value;
            if (this.match(Mi.string) ? s2.key = this.parseLiteral(r2, "StringLiteral") : s2.key = this.parseIdentifier(true), this.expect(Mi.colon), "type" !== r2 && this.raise(s2.key.start, Gi.ModuleAttributeDifferentFromType, r2), e2.has(r2) && this.raise(s2.key.start, Gi.ModuleAttributesWithDuplicateKeys, r2), e2.add(r2), !this.match(Mi.string)) throw this.unexpected(this.state.start, Gi.ModuleAttributeInvalidValue);
            s2.value = this.parseLiteral(this.state.value, "StringLiteral"), this.finishNode(s2, "ImportAttribute"), t2.push(s2);
          } while (this.eat(Mi.comma));
          return t2;
        }
        maybeParseModuleAttributes() {
          if (!this.match(Mi._with) || this.hasPrecedingLineBreak()) return this.hasPlugin("moduleAttributes") ? [] : null;
          this.expectPlugin("moduleAttributes"), this.next();
          const t2 = [], e2 = /* @__PURE__ */ new Set();
          do {
            const s2 = this.startNode();
            if (s2.key = this.parseIdentifier(true), "type" !== s2.key.name && this.raise(s2.key.start, Gi.ModuleAttributeDifferentFromType, s2.key.name), e2.has(s2.key.name) && this.raise(s2.key.start, Gi.ModuleAttributesWithDuplicateKeys, s2.key.name), e2.add(s2.key.name), this.expect(Mi.colon), !this.match(Mi.string)) throw this.unexpected(this.state.start, Gi.ModuleAttributeInvalidValue);
            s2.value = this.parseLiteral(this.state.value, "StringLiteral"), this.finishNode(s2, "ImportAttribute"), t2.push(s2);
          } while (this.eat(Mi.comma));
          return t2;
        }
        ...
        parseNamedImportSpecifiers(t2) {
          ...
          for (this.expect(Mi.braceL); !this.eat(Mi.braceR); ) {
            if (e2) e2 = false;
              ...
              if (this.eat(Mi.colon)) throw this.raise(this.state.start, Gi.DestructureNamedImport);
              if (this.expect(Mi.comma), this.eat(Mi.braceR)) break;
            }
        ...
        parseImportSpecifier(t2) {
          const e2 = this.startNode();
          if (e2.imported = this.parseModuleExportName(), this.eatContextual("as")) e2.local = this.parseIdentifier();
          else {
            const { imported: t3 } = e2;
            if ("StringLiteral" === t3.type) throw this.raise(e2.start, Gi.ImportBindingIsString, t3.value);
        ...
        constructor(t2, e2) {
          super(t2 = function(t3) {
            const e3 = {};
            for (const s2 of Object.keys(Qa)) e3[s2] = t3 && null != t3[s2] ? t3[s2] : Qa[s2];
            return e3;
      ...
      function En(t2, e2) {
        ...
        return null != t2 && t2.plugins && (!function(t3) {
          if (Ga(t3, "decorators")) {
            if (Ga(t3, "decorators-legacy")) throw new Error("Cannot use the decorators and decorators-legacy plugin together");
            const e3 = Ka(t3, "decorators", "decoratorsBeforeExport");
            if (null == e3) throw new Error("The 'decorators' plugin requires a 'decoratorsBeforeExport' option, whose value must be a boolean. If you are migrating from Babylon/Babel 6 or want to use the old decorators proposal, you should use the 'decorators-legacy' plugin instead of 'decorators'.");
            if ("boolean" != typeof e3) throw new Error("'decoratorsBeforeExport' must be a boolean.");
          }
          if (Ga(t3, "flow") && Ga(t3, "typescript")) throw new Error("Cannot combine flow and typescript plugins.");
          if (Ga(t3, "placeholders") && Ga(t3, "v8intrinsic")) throw new Error("Cannot combine placeholders and v8intrinsic plugins.");
          if (Ga(t3, "pipelineOperator") && !Xa.includes(Ka(t3, "pipelineOperator", "proposal"))) throw new Error("'pipelineOperator' requires 'proposal' option whose value should be one of: " + Xa.map((t4) => "'".concat(t4, "'")).join(", "));
          if (Ga(t3, "moduleAttributes")) {
            if (Ga(t3, "importAssertions")) throw new Error("Cannot combine importAssertions and moduleAttributes plugins.");
            if ("may-2020" !== Ka(t3, "moduleAttributes", "version")) throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.");
          }
          if (Ga(t3, "recordAndTuple") && !Ja.includes(Ka(t3, "recordAndTuple", "syntaxType"))) throw new Error("'recordAndTuple' requires 'syntaxType' option whose value should be one of: " + Ja.map((t4) => "'".concat(t4, "'")).join(", "));
      ...
      var xn = function(t2, e2) {
        var s2;
        if ("unambiguous" !== (null == (s2 = e2) ? void 0 : s2.sourceType)) return En(e2, t2).parse();
        e2 = Object.assign({}, e2);
        try {
          e2.sourceType = "module";
          const s3 = En(e2, t2), r2 = s3.parse();
          if (s3.sawUnambiguousESM) return r2;
          if (s3.ambiguousScriptDifferentAst) try {
            return e2.sourceType = "script", En(e2, t2).parse();
          } catch (t3) {
          }
          else r2.program.sourceType = "script";
          return r2;
        } catch (s3) {
          try {
            return e2.sourceType = "script", En(e2, t2).parse();
      ...
      function Tn(t2 = {}) {
        ...
        return function(t3) {
          ...
          if (!e2 && Pn(s2.comments)) throw wn(s2.comments[0], "Comment");
          return Bn(s2), s2;
        };
      }
      function wn(t2, e2) {
      ...
      function Bn(t2) {
        switch (t2.type) {
          case "ArrayExpression":
            for (const e2 of t2.elements) null !== e2 && Bn(e2);
            return;
          case "ObjectExpression":
            for (const e2 of t2.properties) Bn(e2);
            return;
          case "ObjectProperty":
            if (t2.computed) throw wn(t2.key, "Computed key");
            if (t2.shorthand) throw wn(t2.key, "Shorthand property");
            return "Identifier" !== t2.key.type && Bn(t2.key), void Bn(t2.value);
          case "UnaryExpression": {
            const { operator: e2, argument: s2 } = t2;
            if ("+" !== e2 && "-" !== e2) throw wn(t2, "Operator '".concat(t2.operator, "'"));
            if ("NumericLiteral" === s2.type || "Identifier" === s2.type && ("Infinity" === s2.name || "NaN" === s2.name)) return;
            throw wn(s2, "Operator '".concat(e2, "' before '").concat(s2.type, "'"));
          }
          case "Identifier":
            if ("Infinity" !== t2.name && "NaN" !== t2.name && "undefined" !== t2.name) throw wn(t2, "Identifier '".concat(t2.name, "'"));
            return;
          case "TemplateLiteral":
            if (Pn(t2.expressions)) throw wn(t2.expressions[0], "'TemplateLiteral' with expression");
            for (const e2 of t2.quasis) Bn(e2);
            return;
          case "NullLiteral":
          case "BooleanLiteral":
          case "NumericLiteral":
      ...
      function Rn(t2, ...e2) {
        return (s2, r2, i2 = {}) => {
          if ("babel" === i2.parser && function(t3, e3) {
            if (e3.filepath && e3.filepath.endsWith(".js.flow")) return true;
            const s3 = vn(t3);
            s3 && (t3 = t3.slice(s3.length));
            const r3 = In(t3, 0);
            return false !== r3 && (t3 = t3.slice(0, r3)), Mn.test(t3);
          }(s2, i2)) return i2.parser = "babel-flow", _n(s2, r2, i2);
          let a2 = e2;

...
if (NODE_MODE2) {
  (_a2 = global2.customElements) !== null && _a2 !== void 0 ? _a2 : global2.customElements = customElements;
}
var DEV_MODE = true;
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      if (DEV_MODE) {
        ...
        (_a6 = this.constructor.__reactivePropertyKeys) === null || _a6 === void 0 ? void 0 : _a6.forEach((p2) => {
          var _a7;
          if (this.hasOwnProperty(p2) && !((_a7 = this.__instanceProperties) === null || _a7 === void 0 ? void 0 : _a7.has(p2))) {
...
var issueWarning2;
if (DEV_MODE2) {
  (_a3 = global3.litIssuedWarnings) !== null && _a3 !== void 0 ? _a3 : global3.litIssuedWarnings = /* @__PURE__ */ new Set();
...
var slotAssignedElements = ((_a5 = global4.HTMLSlotElement) === null || _a5 === void 0 ? void 0 : _a5.prototype.assignedElements) != null ? (slot, opts) => slot.assignedElements(opts) : (slot, opts) => slot.assignedNodes(opts).filter((node) => node.nodeType === Node.ELEMENT_NODE);
...
var NodeStyles = class {
  constructor(node) {
    ...
    if (node.style) {
      ...
      this.fontPostScriptName = (_a6 = node.style.fontPostScriptName) === null || _a6 === void 0 ? void 0 : _a6.replace("-", " ");
  ...
  class Viewer extends NodeSelectableMixin(PositionedMixin(superClass)) {
    constructor(...args) {
      ...
      _Viewer_getNodeById.set(this, (id) => {
        var _a6, _b4;
        return (_b4 = (_a6 = __classPrivateFieldGet2(this, _Viewer_flattenedNodes, "f")) === null || _a6 === void 0 ? void 0 : _a6.find((n) => n.id === id)) !== null && _b4 !== void 0 ? _b4 : null;
      });
    }
    static get styles() {
    ...
    render() {
      ...
      return html`
        ...
        if (!node || !("absoluteBoundingBox" in node) || !((_a6 = __classPrivateFieldGet2(this, _Viewer_effectMargins, "f")) === null || _a6 === void 0 ? void 0 : _a6[node.id])) {
          return null;
        }
        ...
        var _a6;
        if (node.id === ((_a6 = this.selectedNode) === null || _a6 === void 0 ? void 0 : _a6.id)) {
          return null;
        }
        return svg`
                  <g>
...
var FigspecFileViewer = class extends ViewerMixin(LitElement) {
  constructor() {
    ...
    _FigspecFileViewer_selectFirstPage.set(this, () => {
      ...
      this.selectedPage = (_a6 = this.documentNode.document.children.filter((c) => c.type === "CANVAS")[0]) !== null && _a6 !== void 0 ? _a6 : null;
    });
    _FigspecFileViewer_handlePageChange.set(this, (ev) => {
      var _a6, _b4;
      const target = ev.currentTarget;
      this.selectedPage = (_b4 = (_a6 = this.documentNode) === null || _a6 === void 0 ? void 0 : _a6.document.children.find((c) => c.id === target.value)) !== null && _b4 !== void 0 ? _b4 : null;
    ...
    return html`
      <div class="controls">
        <select @change=${__classPrivateFieldGet3(this, _FigspecFileViewer_handlePageChange, "f")}>
          ${(_a6 = this.documentNode) === null || _a6 === void 0 ? void 0 : _a6.document.children.map((c) => html`<option value=${c.id}>${c.name}</option>`)}
        </select>
      </div>
...
the element.`);
  ...
  class ReactComponent extends Component {
    ...
    componentDidMount() {
      var _a6;
      this._updateElement();
      (_a6 = this._element) === null || _a6 === void 0 ? void 0 : _a6.removeAttribute("defer-hydration");
    }
    /**
     * Updates element properties correctly setting properties
...
var S = N(() => {
  P = ({ config: e, defer: o = false }) => {
    ...
    return (0, import_react2.useEffect)(() => {
      ...
      s(false);
    }, [t]), _a("div", { css: be }, !n && _a(sT, { css: Ce }, "Loading..."), _a("iframe", { css: ve, src: t, allowFullScreen: e.allowFullscreen, onLoad: () => s(true) }));
  }, be = _e`
  position: absolute;
  top: 0;
  right: 0;
...
The addon fallbacks to normal iframe mode.For more detail, please check <https://www.figma.com/developers/embed>.`), e), [e.url, e.allowFullscreen, e.embedHost]);
    return _a(P, { defer: true, config: o });
  };
});
var q = {};
...
`;
  E = ({ config: e }) => {
    ...
    switch ((0, import_react2.useEffect)(() => {
      ...
      case "loading":
        return _a(sT, null, _a(import_react2.Fragment, null, "Loading Figma file..."));
      case "failed":
        return _a(sT, null, _a(import_react2.Fragment, null, "Failed to load Figma file"), _a(import_react2.Fragment, null, o.error));
      case "fetched":
        return o.value.type === "file" ? _a(FigspecFileViewer2, { css: X, ...o.value.props }) : _a(FigspecFrameViewer2, { css: X, ...o.value.props });
    }
  }, Ee = E;
});
L();
...
var oe = ({ children: e, className: o, style: t, defaultValue: r, value: n, onChange: s }) => {
  ...
  return _a("div", { css: Ne, className: o, style: t, ...u }, _a("div", { css: Ue, style: F }, e));
};
var Ne = _e`
  position: relative;
  overflow: hidden;
...
var Ue = _e`
  ...
  left: 0;
`;
var te = ({ onZoomIn: e, onZoomOut: o, onReset: t }) => _a(import_react2.Fragment, null, _a(Ml, { onClick: e }, _a(sM, { icon: "zoom" })), _a(Ml, { onClick: o }, _a(sM, { icon: "zoomout" })), _a(Ml, { onClick: t }, _a(sM, { icon: "zoomreset" })));
var re = (e, o) => {
...
var M = ({ config: e }) => {
  ...
  return _a("div", { css: _e3 }, _a(Jl, { border: true }, _a(import_react2.Fragment, { key: "left" }, _a("p", null, _a("b", null, "Image")), _a(Y1, null), _a(te, { onReset: o.resetZoom, onZoomIn: o.zoomIn, onZoomOut: o.zoomOut }))), _a(oe, { css: We, defaultValue: e.offset }, _a("img", { css: Ye, src: e.url, style: t })));
};
var _e3 = _e`
  position: absolute;
  top: 0;
...
L();
S();
var se = ({ config: e }) => _a("div", { css: Ge }, _a(ju, { cancel: false, href: e.url, target: e.target ?? "_blank", rel: e.rel ?? "noopener", withArrow: e.showArrow ?? true }, e.label || e.url));
var Ge = _e`
  position: absolute;
  top: 0;
  right: 0;
...
S();
var Qe = (e) => {
  if (e.protocol !== "https:") return { valid: false, error: _a(import_react2.Fragment, null, "Expected HTTPS link, received ", _a("code", null, e.protocol), ".") };
  if (e.hostname !== "www.sketch.com") return { valid: false, error: _a(import_react2.Fragment, null, "Expected a hostname ", _a("code", null, "www.sketch.com"), ", received", " ", _a("code", null, e.hostname)) };
  let o = _a(import_react2.Fragment, null, "Expected pathname ", _a("code", null, "/s/<string>/a/<string>"), ", received", " ", _a("code", null, e.pathname), "."), t = e.pathname.split("/").slice(1);
...
var ae = ({ config: e }) => {
  ...
  return o.valid ? _a(P, { defer: true, config: o.data }) : _a(sT, null, _a(import_react2.Fragment, null, "Invalid Sketch URL"), _a(import_react2.Fragment, null, o.error));
};
var ce = ({ tabs: e, deps: o = [] }) => {
  let [t, r] = (0, import_react2.useState)(e[0].id);
  return (0, import_react2.useEffect)(() => {
    r(e[0].id);
  }, o), _a(G1, { absolute: true, selected: t, actions: { onSelect: r } }, e.map((n) => _a("div", { key: n.id, id: n.id, title: n.name }, n.offscreen || t === n.id ? n.content : null)));
};
var no = (0, import_react2.lazy)(() => Promise.resolve().then(() => (H(), q)));
var pe = ({ config: e }) => {
  if (!e || "length" in e && e.length === 0) return _a(sT, null, _a(import_react2.Fragment, null, "No designs found"), _a(import_react2.Fragment, null, "Learn how to", " ", _a(ju, { href: "https://github.com/storybookjs/addon-designs#3-add-it-to-story", target: "_blank", rel: "noopener", withArrow: true, cancel: false }, "display design preview for the story")));
  let o = [...e instanceof Array ? e : [e]].map((t) => {
    var _a6;
    let r = { id: JSON.stringify(t), name: t.name || ((_a6 = t.type) == null ? void 0 : _a6.toUpperCase()) || "ERROR", offscreen: t.offscreen ?? true };
    switch (t.type) {
      case "iframe":
        return { ...r, content: _a(P, { config: t }) };
      case "figma":
        return { ...r, content: _a(B, { config: t }), offscreen: false };
      case "sketch":
        return { ...r, content: _a(ae, { config: t }) };
      case "figspec":
      case "experimental-figspec":
        return t.type === "experimental-figspec" && console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."), { ...r, content: _a(import_react2.Suspense, { fallback: "Preparing Figspec viewer..." }, _a(no, { config: t })), offscreen: false };
      case "image":
        return { ...r, content: _a(M, { config: t }) };
      case "link":
        return { ...r, content: _a(se, { config: t }) };
    }
    return { ...r, content: _a(sT, null, _a(import_react2.Fragment, null, "Invalid config type"), _a(import_react2.Fragment, null, "Config type you set is not supported. Please choose one from", " ", _a(ju, { href: "https://github.com/storybookjs/addon-designs/blob/master/packages/storybook-addon-designs/src/config.ts", target: "_blank", rel: "noopener", withArrow: true, cancel: false }, "available config types"))) };
  });
  return o.length === 1 ? _a("div", null, o[0].content) : _a(ce, { tabs: o, deps: [e] });
};
var de = "design";
var lo = Tr.div(({ theme: e }) => `
  font-family: ${e.typography.fonts.base};
  font-size: ${e.typography.size.s3}px;
  margin: 0;
`);
var mo = Tr.div(({ theme: e, height: o = "60%", collapsed: t }) => `
  position: relative;
  width: 100%;
  height: 0;
  padding: 0;
...
var T = ({ children: e, collapsable: o = true, defaultCollapsed: t = false, placeholder: r, showLink: n = true, onCollapsedChange: s, ...a }) => {
  ...
  return import_react2.default.createElement(lo, null, import_react2.default.createElement(mo, { collapsed: o && l, ...a }, o && l ? import_react2.default.createElement(po, null, r) : e, import_react2.default.createElement(lu, { actionItems: [o && { title: l ? "Show" : "Hide", onClick: () => {
    let c = !l;
    s && s(c, l), u(c);
